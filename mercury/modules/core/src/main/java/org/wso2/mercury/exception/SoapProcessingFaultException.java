...
public class SoapProcessingFaultException extends RMException {
    ...
    public SoapProcessingFaultException(String message) {
        super(message);
    }

    public SoapProcessingFaultException(String message, Throwable cause) {
        super(message, cause);
    }

    public SoapProcessingFaultException(Throwable cause) {
        super(cause);
    }
}
