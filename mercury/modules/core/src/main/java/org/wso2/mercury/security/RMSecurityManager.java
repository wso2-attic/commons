...
package org.wso2.mercury.security;
...
/**
 * This code was copied from Sandesha2 Security Manager.
 *
 * RMSecurityManager interface. This manages the link between the RM layer and Security,
 ...
 */
public abstract class RMSecurityManager {

    public RMSecurityManager(ConfigurationContext context) {
     ...
     * If the elements is not secured with the given token the RMSecurityManager must
     * throw an exception.
     */
    public abstract void checkProofOfPossession(SecurityToken token, MessageContext message)
    throws RMSecurityException;
     ...
     * use this method, and the matching RMSecurityManager method to rebuild the token
     * object.
     */
     ...
     * This gives the RMSecurityManager implementation an opportunity to decorate
