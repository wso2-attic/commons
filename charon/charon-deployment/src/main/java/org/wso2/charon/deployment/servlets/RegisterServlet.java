...
* under the License.
*/
package org.wso2.charon.deployment.servlets;
...
public class RegisterServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            //rep.setAttribute("registered", "true");
            /*RequestDispatcher requestDispatcher = getServletContext().getRequestDispatcher(
                    "endpoint_info.jsp");
            requestDispatcher.forward(req,resp);*/
            resp.sendRedirect("http://localhost:8080/charonDemoApp/endpoint_info.jsp");

        } catch (CharonException e) {
            e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
            req.setAttribute("registered","false");
            resp.sendRedirect("http://localhost:8080/charonDemoApp/register.jsp");
        }
    }
