...
<!--
  ...
  2007-04-18: (JM) added support for schemas without targetNamespaces
  2006-11-07: (JM) code review and cleanup
  2006-10-23: (JM) created
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>Schema for <xsl:value-of select="xs:schema/@targetNamespace"/></title>
				<style type="text/css">
	...
	<xsl:template match="xs:schema">
		...
		<tr>
			<td class="schema-block annotation-area">
				<div class="sidebar"><xsl:call-template name="index-reference"/></div>
			</td>
			<td class="schema-block"><div class="arrow">&#160;</div></td>
...
.markup-comment  {color:green}
	...
	<xsl:template name="attribute">
		...
		<xsl:param name="preconstructed-reference"/>  <!-- allows the reference to be overriden with a preconstructed nodelist -->
		<xsl:text> </xsl:text>
		<span>
			<xsl:choose>
		...
		<span class="{$value-class}">
			<xsl:choose>
				...
				<xsl:when test="$preconstructed-reference">
					<xsl:copy-of select="$preconstructed-reference"/>
				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="."/>
				</xsl:otherwise>
	...
	<xsl:template name="schema-identifier">
		...
		<xsl:if test="@name | @ref">
			<xsl:choose>
				<xsl:when test="(self::xs:attribute or self::xs:element) and not(parent::xs:schema)">
				...
				<xsl:when test="local-name()='complexType' or local-name()='simpleType'">_type</xsl:when>
				<xsl:otherwise>
					<xsl:text>_</xsl:text>
					<xsl:value-of select="local-name()"/>
				</xsl:otherwise>
			...
			<xsl:when test="$supports-namespace-axis">
				<xsl:if test="not(../namespace::*[. = $targetNamespace and name(.) =
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							<xsl:value-of select="ancestor::xs:schema/xs:import[@namespace=$uri]/@schemaLocation"/>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:if>
			</xsl:when>	
		...
		<xsl:if test="xs:schema/xs:complexType">
			<tr>
				<td id="complexType-list" class="annotation-area">
					<div class="complexType sidebar sidebar-title-highlight">Index of complexTypes</div>
				</td>
		...
		<xsl:if test="xs:schema/xs:simpleType">
			<tr>
				<td id="simpleType-list" class="annotation-area">
					<div class="simpleType sidebar sidebar-title-highlight">Index of simpleTypes</div>
				</td>
				<td><div class="arrow">&#160;</div></td>
				<td class="source-area">
		...
		<xsl:if test="xs:schema/xs:element">
			<tr>
				<td id="global-element-list" class="annotation-area">
					<div class="element sidebar sidebar-title-highlight">Index of global elements</div>
				</td>
				<td><div class="arrow">&#160;</div></td>
				<td class="source-area">
		...
		<xsl:if test="xs:schema/*//xs:element[@name]">
			<tr>
				<td id="local-element-list"  class="annotation-area">
					<div class="element sidebar sidebar-title-highlight">Index of local elements</div>
				</td>
				<td><div class="arrow">&#160;</div></td>
				<td class="source-area">
		...
		<xsl:if test="xs:schema/xs:attribute">
			<tr>
				<td id="global-attribute-list" class="annotation-area">
					<div class="attribute sidebar sidebar-title-highlight">Index of global attributes</div>
				</td>
				<td><div class="arrow">&#160;</div></td>
				<td class="source-area">
		...
		<xsl:if test="xs:schema/*//xs:attribute[@name]">
			<tr>
				<td id="local-attribute-list" class="annotation-area">
					<div class="attribute sidebar sidebar-title-highlight">Index of local attributes</div>
				</td>
				<td><div class="arrow">&#160;</div></td>
				<td class="source-area">
		...
		<xsl:if test="xs:schema/xs:attributeGroup">
			<tr>
				<td id="attributeGroup-list" class="annotation-area">
					<div class="attributeGroup sidebar sidebar-title-highlight">Index of attribute groups</div>
				</td>
				<td><div class="arrow">&#160;</div></td>
				<td class="source-area">
