...
@WebService(serviceName = "Benchmark", targetNamespace = "http://www.extreme.indiana.edu/wsdl/Benchmark1", endpointInterface = "edu.indiana.extreme.wsdl.benchmark1.Benchmark")
...
public class BenchmarkImpl
    ...
    public EchoStringsResponse echoStrings(EchoStrings echoStrings) {
        ...
        response.echoStringsReturn = echoStrings.getInput();
        return response;
    }
    ...
    public SendIntsResponse sendInts(SendInts sendInts) {
        ...
        response.sendIntsReturn = output;
        return response;
    }
    ...
    public ReceiveDoublesResponse receiveDoubles(ReceiveDoubles receiveDoubles) {
        ...
        response.setReceiveDoublesReturn(receiveDoubles.getInput().size());
        return response;
    }
    ...
    public ReceiveMeshInterfaceObjectsResponse receiveMeshInterfaceObjects(ReceiveMeshInterfaceObjects receiveMeshInterfaceObjectsRequest) {
        ...
        response.receiveMeshInterfaceObjectsReturn = receiveMeshInterfaceObjectsRequest.getInput().size();
        return response;
    }
    ...
    public EchoSimpleEventsResponse echoSimpleEvents(EchoSimpleEvents echoSimpleEventsRequest) {
        ...
        response.echoSimpleEventsReturn = echoSimpleEventsRequest.getInput();
        return response;
    }
    ...
    public SendDoublesResponse sendDoubles(SendDoubles sendDoubles) {
        ...
        response.sendDoublesReturn = output;
        return response;
    }
    ...
    public EchoDoublesResponse echoDoubles(EchoDoubles echoDoubles) {
        ...
        response.echoDoublesReturn = echoDoubles.getInput();
        return response;
    }
    ...
    public SendStringsResponse sendStrings(SendStrings sendStrings) {
        ...
        response.sendStringsReturn = output;
        return response;
    }
    ...
    public EchoMeshInterfaceObjectsResponse echoMeshInterfaceObjects(EchoMeshInterfaceObjects echoMeshInterfaceObjectsRequest) {
        ...
        response.item = echoMeshInterfaceObjectsRequest.getInput();
        return response;
    }
    ...
    public ReceiveSimpleEventsResponse receiveSimpleEvents(ReceiveSimpleEvents receiveSimpleEventsRequest) {
        ...
        response.receiveSimpleEventsReturn = receiveSimpleEventsRequest.getInput().size();
        return response;
    }
