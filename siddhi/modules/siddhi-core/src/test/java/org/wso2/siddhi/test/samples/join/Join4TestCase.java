...
public class Join4TestCase {

    private static final Logger log = Logger.getLogger(Join4TestCase.class);
    private volatile boolean eventCaptured = false;
    private volatile int i = 0;

    @Before
    public void info() {
        log.debug("-----Query processed: Testing aggregation on join with time window Group by-----");
        eventCaptured = false;
        i=0 ;
    }
