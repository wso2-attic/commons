...
public class SimpleFilterInt5TestCase extends SimpleFilterBaseTestCase {

    private final Logger log = Logger.getLogger(this.getClass());

    protected SimpleCondition createAPICondition(QueryFactory qf) {
        return qf.condition("CSEStream.price*2", EQUAL, "CSEStream.price+(1+1)*3");
    }

    @Override
    protected String createQueryCondition() {
        return   "price*2 == price+(1+1)*3";
    }
