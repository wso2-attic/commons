    ...
    public void testQuery1() throws InterruptedException {
        ...
        query.from(
                QueryFactory.patternStream(
                        Pattern.followedBy(
                                Pattern.every(
                                        QueryFactory.inputStream("e1", "STS").handler(
                                                Condition.compare(Expression.variable("setpoint"),
                                                                  Condition.Operator.LESS_THAN,
                                                                  Expression.value(70)))),
                                QueryFactory.inputStream("e2", "STM").handler(
        ...
        query.project(
                QueryFactory.outputProjector().
                        project("STSEventID", Expression.variable("e1", "eventID")).
                        project("STMEventID", Expression.variable("e2", "eventID"))
        );
                                ...
                                Pattern.every(
                                        QueryFactory.inputStream("e1", "STS").handler(
                                                Condition.compare(Expression.variable("setpoint"),
                                                                  Condition.Operator.LESS_THAN,
                                                                  Expression.value(70)))),
                                Pattern.every(QueryFactory.inputStream("e2", "STM").handler(
                                        Condition.compare(Expression.variable("reading"),
                                                          Condition.Operator.LESS_THAN,
                                                          Expression.value(70)))))));
        ...
        query.from(
                QueryFactory.joinStream(
                        QueryFactory.inputStream("e1", "STS").
                                handler(Condition.compare(Expression.variable("setpoint"),
                                                          Condition.Operator.LESS_THAN,
                                                          Expression.value(70))).
                                handler(Handler.Type.WIN, "time", 50000),
                        JoinStream.Type.INNER_JOIN,
                        QueryFactory.inputStream("e2", "STM").
                                handler(Condition.compare(Expression.variable("reading"),
                                                          Condition.Operator.LESS_THAN,
                                                          Expression.value(70))).
                                handler(Handler.Type.WIN, "time", 50000)
                ));
                ...
                QueryFactory.joinStream(
                        QueryFactory.inputStream("e1", "STS").
                                handler(Condition.compare(Expression.variable("setpoint"),
                                                          Condition.Operator.LESS_THAN,
                                                          Expression.value(70))).
                                handler(Handler.Type.WIN, "time", 5000),
                        JoinStream.Type.INNER_JOIN,
                        QueryFactory.inputStream("e2", "STM").
                                handler(Condition.compare(Expression.variable("reading"),
                                                          Condition.Operator.LESS_THAN,
