...
//
                                ...
                                QueryFactory.inputStream("e4", "Stream2").handler(
                                        Condition.compare(Expression.variable("price"),
                                                          Condition.Operator.GREATER_THAN,
                                                          Expression.variable("e1", "price"))))));
        ...
        query.project(
                QueryFactory.outputProjector().
                        ...
                        project("price4", Expression.variable("e4", "price"))
    ...
    public void testQuery2() throws InterruptedException {
        ...
        query.project(
                QueryFactory.outputProjector().
                        project("price1", Expression.variable("e1", "price")).
                        project("price2.0", Expression.variable("e2", 0, "price")).
                        project("price2.1", Expression.variable("e2", 1, "price")).
                        project("price3", Expression.variable("e3", "price"))
