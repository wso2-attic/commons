...
public class NegationPattern1TestCase {

    private static final Logger log = Logger.getLogger(NegationPattern1TestCase.class);
    ...
    public void testAPI() throws SiddhiException, InterruptedException {
        ...
        Query query = qf.createQuery(
                ...
                qf.pattern(
                        qf.condition("infoStock.action", ConditionOperator.EQUAL, "buy"),  //0
