...
public class SimpleFilterInt1TestCase extends SimpleFilterBaseTestCase {

    private final Logger log = Logger.getLogger(this.getClass());


    protected SimpleCondition createAPICondition(QueryFactory qf) {
        return qf.condition("CSEStream.price", EQUAL, "5");
    }
    ...
    protected void assertEvent(Event event) {
        Assert.assertEquals(event.getNthAttribute(0), 5);
    }
}
