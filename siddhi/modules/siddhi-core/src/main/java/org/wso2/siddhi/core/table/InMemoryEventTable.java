...
public class InMemoryEventTable implements EventTable, Persister {
    ...
    public void save(PersistenceManagementEvent persistenceManagementEvent) {
        persistenceStore.save(persistenceManagementEvent, elementId, new PersistenceObject(list.currentState()));
    }
    ...
    public void load(PersistenceManagementEvent persistenceManagementEvent) {
        ...
        list.restoreState((Object[]) persistenceObject.getData()[0]);
    }
