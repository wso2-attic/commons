...
public class RightJoinInStreamPacker extends JoinStreamPacker {

    public RightJoinInStreamPacker(ConditionExecutor onConditionExecutor, boolean triggerEvent,
                                   ReentrantLock lock) {
    ...
    protected StateEvent createNewEvent(ComplexEvent complexEvent, ComplexEvent complexEvent1) {
        return new InStateEvent(new Event[]{((Event) complexEvent1), ((Event) complexEvent)});
    }
