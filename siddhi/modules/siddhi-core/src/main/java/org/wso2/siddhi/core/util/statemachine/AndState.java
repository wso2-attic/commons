...
public class AndState extends State implements LogicState {

    private int partner = -1;

    public AndState(int stateNumber, SingleStream singleStream, int partnerNum) {
        super(stateNumber, singleStream);
