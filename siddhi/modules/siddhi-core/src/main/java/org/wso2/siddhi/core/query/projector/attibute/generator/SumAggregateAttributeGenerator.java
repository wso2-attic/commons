...
public class SumAggregateAttributeGenerator extends AbstractAggregateAttributeGenerator {
    private ExpressionExecutor expressionExecutor;
    private Aggregator aggregator;

    public SumAggregateAttributeGenerator() {
    }

    private SumAggregateAttributeGenerator(Aggregator aggregator,
    ...
    public void assignExpressions(Expression[] expressions,
        ...
        aggregator = AggregatorParser.createSumAggregator(expressionExecutor.getType());
    }

    @Override
    public AbstractAggregateAttributeGenerator createNewInstance() {
        return new SumAggregateAttributeGenerator(aggregator.createNewInstance(),expressionExecutor);
    }
