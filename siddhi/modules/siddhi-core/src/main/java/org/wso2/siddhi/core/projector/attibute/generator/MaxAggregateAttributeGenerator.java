...
public class MaxAggregateAttributeGenerator extends AbstractAggregateAttributeGenerator {
    ...
    private MaxAggregateAttributeGenerator(Aggregator aggregator,
    ...
    public void assignExpressions(Expression[] expressions,
        ...
        aggregator = AggregatorParser.createMaxAggregator(expressionExecutor.getType());
    }

    @Override
    public AbstractAggregateAttributeGenerator createNewInstance() {
        return new MaxAggregateAttributeGenerator(aggregator.createNewInstance(),expressionExecutor);
    }
