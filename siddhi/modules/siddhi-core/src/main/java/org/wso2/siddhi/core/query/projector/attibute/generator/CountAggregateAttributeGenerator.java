...
public class CountAggregateAttributeGenerator extends AbstractAggregateAttributeGenerator {
    private ExpressionExecutor expressionExecutor;
    private Aggregator aggregator;

    public CountAggregateAttributeGenerator() {
    }

    private CountAggregateAttributeGenerator(Aggregator aggregator,
    ...
    public void assignExpressions(Expression[] expressions,
        ...
        aggregator = AggregatorParser.createCountAggregator(expressionExecutor.getType());
    }

    @Override
    public AbstractAggregateAttributeGenerator createNewInstance() {
        return new CountAggregateAttributeGenerator(aggregator.createNewInstance(),expressionExecutor);
    }
