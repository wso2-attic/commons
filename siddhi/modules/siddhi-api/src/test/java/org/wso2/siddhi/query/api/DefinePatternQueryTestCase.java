    ...
    public void testCreatingFilterPatternQuery() {
        ...
        query.from(
                QueryFactory.patternStream(
                        Pattern.followedBy(
                                QueryFactory.inputStream("e1", "Stream1").handler(Condition.compare(Expression.variable("price"),
                                                                                                    Condition.Operator.GREATER_THAN_EQUAL,
                                                                                                    Expression.value(30))),
                                Pattern.followedBy(QueryFactory.inputStream("e2", "Stream1").handler(Condition.compare(Expression.variable("price"),
                                                                                                                       Condition.Operator.GREATER_THAN_EQUAL,
                                                                                                                       Expression.value(20))),
        ...
        query.project(
                QueryFactory.outputProjector().
                        project("symbol", Expression.variable("e1", "symbol")).
                        project("avgPrice", "avg", Expression.variable("e2", "price")).
                        groupBy("e1", "symbol").
...
//    a1.action as action, b1.price as priceA, b2.price as priceB
    ...
    public void testCreatingPatternQuery() {
        ...
        query.project(
                QueryFactory.outputProjector().
                        project("action", Expression.variable("a1", "action")).
                        project("priceA", Expression.variable("b1", "price")).
                        project("priceB", Expression.variable("b2", "price"))
