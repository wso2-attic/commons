...
public abstract class AbstractDefinition implements ExecutionPlan {
    ...
    public Attribute.Type getAttributeType(String attributeName) {
        ...
        throw new AttributeNotExistException("Cannot find attribute type as " + attributeName + " dose not exist in "+id);
    }
    ...
    public int getAttributePosition(String attributeName) {
        ...
        throw new AttributeNotExistException("Cannot get attribute position as " + attributeName + " dose not exist in "+id);
    }
