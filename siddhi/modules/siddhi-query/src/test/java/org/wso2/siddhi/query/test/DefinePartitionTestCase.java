...
public class DefinePartitionTestCase {
    ...
    @Test
    public void testPartitionDefinition() throws RecognitionException, SiddhiPraserException {
    ...
    @Test
    public void testPartitionDefinition2() throws RecognitionException, SiddhiPraserException {
        PartitionDefinition partitionDefinition =
                SiddhiCompiler.parsePartitionDefinition("define partition bySymbolLarge by cseStream.symbol, range cseStream.volume >= 100 as 'Large'");
