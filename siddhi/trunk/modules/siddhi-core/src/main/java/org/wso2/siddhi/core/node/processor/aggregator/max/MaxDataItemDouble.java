 ...
 */
public class MaxDataItemDouble implements WindowedDataItem<Double> {
    ...
    public MaxDataItemDouble(EventQueue window, int valuePosition) {
        this.window = window;
    ...
    public DataItem getNewInstance() {
        return new MaxDataItemDouble(this.window, this.valuePosition);
    }
}
