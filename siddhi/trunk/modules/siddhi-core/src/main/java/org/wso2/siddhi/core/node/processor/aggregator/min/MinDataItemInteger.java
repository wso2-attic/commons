...
public class MinDataItemInteger implements WindowedDataItem<Integer> {
    ...
    public MinDataItemInteger(EventQueue window, int valuePosition) {
        this.window = window;
    ...
    public DataItem getNewInstance() {
        return new MinDataItemInteger(this.window, this.valuePosition);
    }
}
