...
public class SimpleFilterContainsTestCase {

    private static final Logger log = Logger.getLogger(SimpleFilterContainsTestCase.class);
    ...
    public void testAPI() throws SiddhiException, EventStreamNotFoundException,
        ...
        Query query = qf.createQuery(
                ...
                qf.condition("CSEStream.symbol", CONTAINS, "M")
        );
