...
public class SumOverTimeBatchWindowTestCase {

    private static final Logger log = Logger.getLogger(SumOverTimeBatchWindowTestCase.class);
    ...
    public void testAPI() throws ProcessorInitializationException, InvalidQueryException,
        ...
        Query query = qf.createQuery(
                ...
                qf.from(cseEventStream).setWindow(WindowType.TIME_BATCH, 500),
