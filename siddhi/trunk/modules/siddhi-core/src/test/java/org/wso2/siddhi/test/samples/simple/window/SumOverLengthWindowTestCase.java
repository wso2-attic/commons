...
public class SumOverLengthWindowTestCase {

    private static final Logger log = Logger.getLogger(SumOverLengthWindowTestCase.class);
    ...
    public void testAPI() throws SiddhiException, InterruptedException,
        ...
        Query query = qf.createQuery(
                ...
                qf.from(cseEventStream).setWindow(WindowType.LENGTH, 4),
    ...
    @Test
    public void testQuery() throws SiddhiException, InterruptedException,
                                   ProcessorInitializationException, InvalidQueryException,
    ...
    private void sendEvents(InputHandler inputHandler) throws InterruptedException {
        Integer[] price = new Integer[]{10, 20, 30, 40, 50, 10, 20};
            ...
            public void callBack(Event event) {
                ...
                switch (i) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        Assert.assertTrue(event.<Integer>getNthAttribute(1) == 130);
                        break;
                    case 8:
                        Assert.assertTrue(event.<Integer>getNthAttribute(1) == 100);
                        break;
