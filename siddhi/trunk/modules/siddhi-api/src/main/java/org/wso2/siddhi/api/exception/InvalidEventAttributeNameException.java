...
public class InvalidEventAttributeNameException extends RuntimeException {
    ...
    public InvalidEventAttributeNameException(String s) {
        super(s);
    }

    public InvalidEventAttributeNameException(String s, Throwable throwable) {
        super(s,throwable);
    }

    public InvalidEventAttributeNameException(Throwable throwable) {
        super(throwable);
    }
}
