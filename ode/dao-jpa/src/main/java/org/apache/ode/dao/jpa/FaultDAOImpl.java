...
public class FaultDAOImpl implements FaultDAO {
	...
	public Element getData() {
		...
		try {
            // Empty string checking introduced to handle error occurred during Oracle DB use
            // Oracle sends back null values as empty strings.
			ret = (_data == null || _data.equals(""))?null:DOMUtils.stringToDOM(_data);
		} catch (Exception e) {
