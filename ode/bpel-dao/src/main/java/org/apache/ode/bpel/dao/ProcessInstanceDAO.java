...
public interface ProcessInstanceDAO {
    ...
    /**
     * This method is added to use with Instance cleanup task and instance deletion operation in
     * management API. With the current design, we can't delete message exchange DAOs when doing
     * instance cleanup due to use of message exchange DAO to send the response back. So management
     * API and instance cleanup tool can use this method to delete message exchange DAOs.
     * @return
     */
    void deleteMessageExchangeDAOs();
