...
public class PerfParams implements Serializable
{
   ...
   private String senderQueueLookup = "/queue/testPerfQueue";
   private String receiverQueueLookup = "/queue/testPerfQueue";
   ...
   public String getSenderQueueLookup()
   {
      return senderQueueLookup;
   }

   public void setSenderQueueLookup(final String senderQueueLookup)
   {
      this.senderQueueLookup = senderQueueLookup;
   }

   public String getReceiverQueueLookup()
   {
      return receiverQueueLookup;
   }

   public void setReceiverQueueLookup(final String receiverQueueLookup)
   {
      this.receiverQueueLookup = receiverQueueLookup;
   }
   ...
   public void setIsListenerOnly(final boolean listenerOnly)
   {
      this.listenerOnly = listenerOnly;
   }
   ...
   public String toString()
   {
      return "message to send = " + noOfMessagesToSend + ", DeliveryMode = " +
              ...
              ", sender queue lookup = " + senderQueueLookup + ", receiver queue lookup = " + receiverQueueLookup + 
              ", connection factory lookup = " + connectionFactoryLookup +
