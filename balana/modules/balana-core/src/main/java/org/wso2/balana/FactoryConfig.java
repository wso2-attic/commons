...
/**
 * Encapsulates the attribute, combine,function and other factory configurations  for building
 * the XACML policy
 */
public class FactoryConfig {
    ...
    public FactoryConfig(AttributeFactoryProxy attributeFactoryProxy,
             CombiningAlgFactoryProxy algFactoryProxy,  FunctionFactoryProxy functionFactoryProxy) {
        this.attributeFactoryProxy = attributeFactoryProxy;
        this.algFactoryProxy = algFactoryProxy;
        this.functionFactoryProxy = functionFactoryProxy;
    }

    public AttributeFactoryProxy getAttributeFactoryProxy() {
        return attributeFactoryProxy;
    }

    public CombiningAlgFactoryProxy getAlgFactoryProxy() {
        return algFactoryProxy;
    }
