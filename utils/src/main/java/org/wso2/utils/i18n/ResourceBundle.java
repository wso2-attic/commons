...
public class ResourceBundle {
     ...
     */
    public ResourceBundle(String name) throws MissingResourceException {
        this(null, name, null);
    }
     ...
     * @param name   The name of the property file without the ".properties" extension
     */
    public ResourceBundle(Object caller, String name) throws MissingResourceException {
     ...
     */
    public ResourceBundle(Object caller, String name, Locale locale) throws MissingResourceException {
        ClassLoader cl = null;
    ...
    public static String getMessage(Object caller, String basename, Locale locale, String key,
        ...
        while (msg == null) {
            ...
            try {
                ResourceBundle resourceBundle = new ResourceBundle(caller, fullName, locale);
                msg = resourceBundle.getString(key, args);
