...
public class LessThanCompareConditionExecutorLongLong extends
                                                      LessThenCompareConditionExecutor {


    public LessThanCompareConditionExecutorLongLong(ExpressionExecutor leftExpressionExecutor,
