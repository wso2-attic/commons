...
public class BpelServerImpl implements BpelServer, Scheduler.JobProcessor {
    ...
    /**
     * This is the unsecured version of above method getEngine. Please use with care.
     * This is a hack to make BPS instance management work.
     * TODO: Need to refactor this code in Apache ODE to make it more flexible to manage process engine.
     * @return
     */
