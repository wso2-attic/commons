...
system("md #$CATALINA_HOME\\webapps\\esb")
system("md #$CATALINA_HOME\\webapps\\esb\\WEB-INF")
system ("xcopy  #$CARBON_BIN_HOME\\webapps\\ROOT\\WEB-INF #$CATALINA_HOME\\webapps\\esb\\WEB-INF /S")
