...
public class MTOMClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String targetEPR = getProperty("opt_url", "http://localhost:8280/soap");
        String fileName = getProperty("opt_file", "/opt/sign_only/resources/WSO2-ESB-AdministratorGuide.doc");
    ...
    public static MessageContext sendUsingSwA(String fileName, String targetEPR) throws IOException {
        ...
        File tempFile = File.createTempFile("swa-", ".doc");
