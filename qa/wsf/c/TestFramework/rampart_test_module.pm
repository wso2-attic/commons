...
sub invoke_tests
{
    print "Invoking rampart tests...\n";
    $logger->info ("Invoking rampart tests...\n");
    my @output;
    my $all = 0;
    my $success = 0;
    my $fail = 0;
    ...
    $logger->info ("got children of \"rampart_tests\" by tag name $nodes[0]");
...
sub build_testcases
{
  ...
  chdir "rampart" or die "unable to change director ";
