...
import org.wso2.wsas.service.Rampart_SIGNONLY_Echo_serviceStub;
import org.apache.axis2.Constants;

public class SignonlyClient{
...
public static void main(String args[])throws AxisFault{
	...
	Rampart_SIGNONLY_Echo_serviceStub stub = new Rampart_SIGNONLY_Echo_serviceStub(ctx,args[3]);
	Rampart_SIGNONLY_Echo_serviceStub.EchoString request = new Rampart_SIGNONLY_Echo_serviceStub.EchoString();
	request.setS("Rampart Sign Only!!!!");
	...
	try {
		Rampart_SIGNONLY_Echo_serviceStub.EchoStringResponse response = stub.echoString(request);
