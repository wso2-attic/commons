...
system("md #$CATALINA_HOME\\webapps\\wsas")
system("md #$CATALINA_HOME\\webapps\\wsas\\WEB-INF")
system ("xcopy  #$CARBON_BIN_HOME\\webapps\\ROOT\\WEB-INF #$CATALINA_HOME\\webapps\\wsas\\WEB-INF /S")
