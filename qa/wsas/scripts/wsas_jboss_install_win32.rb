...
$JBOSS_HOME="D:\\software\\jboss-5.0.0.GA"
...
system("md #$wsas_repo")
system("md #$wsas_repo\\conf")
system("md #$wsas_repo\\repository")
system("md #$wsas_repo\\database")
system("md #$wsas_repo\\resources")
system ("xcopy  #$CARBON_BIN_HOME\\conf #$wsas_repo\\conf /S")
system ("xcopy  #$CARBON_BIN_HOME\\repository #$wsas_repo\\repository /S")
system ("xcopy  #$CARBON_BIN_HOME\\database #$wsas_repo\\database /S" )
system ("xcopy  #$CARBON_BIN_HOME\\resources #$wsas_repo\\resources /S")
...
system("md #$JBOSS_HOME\\server\\default\\deploy\\wso2wsas.war")
system("md #$JBOSS_HOME\\server\\default\\deploy\\wso2wsas.war\\WEB-INF")
system ("xcopy  #$CARBON_BIN_HOME\\webapps\\ROOT\\WEB-INF #$JBOSS_HOME\\server\\default\\deploy\\wso2wsas.war\\WEB-INF /S")
