...
public class ESBClassMediatorTest extends TestCase {
	 ...
	 */
    public void addClassMediator(String level, String className) throws Exception{
    ...
    /*
    This method will add values for the parameters
     */
    public void addValues(String paramVal) throws Exception{
        selenium.type("propertyValue"+paramNo, paramVal);
        paramNo++;
    }
}
