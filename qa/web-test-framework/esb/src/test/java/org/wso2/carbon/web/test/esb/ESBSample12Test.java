...
public class ESBSample12Test extends CommonSetup
{
    public ESBSample12Test(String text) {
        super(text);
    }
...
//    <send/>
    ...
    public void invokeClient() throws Exception{
        ...
        boolean stockQuoteResponse = esbSampleClient.placeOrderClient("http://"+esbCommon.getHostName()+":"+esbCommon.getNioHttpPort()+"/" ,esbCommon.getServiceAddUrl("SimpleStockQuoteService"));
    ...
    public void testSample5Config() throws Exception{
        ...
        createSequence("sample_12");
        //Setting the created sequence to the main sequence
        esbCommon.setSequenceToSequence("main","sample_12");
        seleniumTestBase.logOutUI();
        invokeClient();
    }
}
