...
public class ESBSample351Test extends CommonSetup{
    Properties properties = new Properties();

    public ESBSample351Test(String text) {
        super(text);
    }
...
//    </out>
    ...
    public void createSequence(String seqName) throws Exception{
        ...
        try {
            File file = new File(".." + File.separator + "esb" + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "responseJavaScript.js");
        ...
        esbScriptMediatorTest.addInlineScripts ("0.0","Javascript",requestContent);
        ...
        esbScriptMediatorTest.addInlineScripts ("1.0","Javascript",responseContent);
        esbCommon.mediatorUpdate();
        ...
        esbCommon.setSequenceToSequence("main","sample_351");
    }
