...
public class ESBAddNonWsdlProxyServiceTest extends CommonSetup {
   ...
   /*
    ...
    public void testSetGeneralSettings() throws Exception{
        ...
        esbAddProxyServiceTest.addProxyName("proxy_non_wsdl", "Custom Proxy");
    ...
    */
    public void testVerifyProxy() throws Exception{
        ESBAddProxyServiceTest esbAddProxyServiceTest = new ESBAddProxyServiceTest(selenium);
        esbAddProxyServiceTest.verifyProxy("proxy_non_wsdl");
    }
    ...
    */
    ...
    public void testInvokeClient() throws Exception{
        ...
        {
            stockQuoteResponse = sampleClient.stockQuoteClientforProxy("http://"+esbCommon.getHostName()+":"+esbCommon.getNioHttpPort()+"/services/proxy_non_wsdl", null, "IBM");
        }
        else
        {
            stockQuoteResponse = sampleClient.stockQuoteClientforProxy("http://"+esbCommon.getHostName()+":"+esbCommon.getNioHttpPort()+"/"+esbCommon.getContextRoot()+"/services/proxy_non_wsdl", null, "IBM");
        }
    ...
    public void testDeleteProxyService()throws Exception{
        ESBAddProxyServiceTest esbAddProxyServiceTest = new ESBAddProxyServiceTest(selenium);
        esbAddProxyServiceTest.deleteProxyService("proxy_non_wsdl");
    }
    ...
    public void testVerifyProxyDeleted() throws Exception{
        ESBAddProxyServiceTest esbAddProxyServiceTest = new ESBAddProxyServiceTest(selenium);
        esbAddProxyServiceTest.verifyProxyDelete("proxy_non_wsdl");
    }
