...
public class ESBCloneMediatorTest  extends TestCase {
	 ...
	 */
     public void addCloneMediator(String level, String cloneContinue) throws Exception{
        selenium.click("//a[@id='mediator-"+level+"']");
        Thread.sleep(2000);
        selenium.select("mediator.clone.continue", "label="+cloneContinue);
    }

    public void addCloneTarget(String level) throws Exception{
        selenium.click("//a[@id='mediator-"+level+"']");
        Thread.sleep(2000);
	 ...
	 */
    public void addTargetMediator(String level,String soapAction, String toAddress, String sequenceOption, String endpointOption, String seqResourceName, String eprResourceName) throws Exception{
        selenium.click("//a[@id='mediator-"+level+"']");
        Thread.sleep(2000);
        if(soapAction!=null)
