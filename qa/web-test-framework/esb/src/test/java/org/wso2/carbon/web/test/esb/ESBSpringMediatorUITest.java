...
public class ESBSpringMediatorUITest  extends TestCase {
    Selenium selenium;

    public ESBSpringMediatorUITest(Selenium _browser){
		selenium = _browser;
    }
	 ...
	 */
    public void testVerifySpringMediatorUI(String level) throws Exception{
        selenium.click("//a[@id='mediator-"+level+"']");
        Thread.sleep(2000);        
        assertTrue(selenium.isTextPresent("Spring Mediator"));
        assertTrue(selenium.isTextPresent("Bean *"));
...
//        esbCommon.testMediatorHelp("Spring");
    }
}
