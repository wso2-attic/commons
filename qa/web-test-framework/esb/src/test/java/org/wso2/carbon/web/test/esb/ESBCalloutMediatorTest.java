...
public class ESBCalloutMediatorTest   extends TestCase {
	 ...
	 */
    public void addCalloutMediator(String level, String svcURL, String action, String repo, String axis2XML) throws Exception{
    ...
    */
   public void addSourceInfo(String sourceXpath, String sourceSpecifyAs, String nsLevel, String xpathNamespacePrefix, String xpathNamespaceURI, String sourceResource) throws Exception{
        ...
        if (sourceSpecifyAs.equals("sourceGroupXPath")){
            ...
            esbCommon.addNamespace(xpathNamespacePrefix,xpathNamespaceURI);
        } else {
            ...
            esbCommon.selectResource("Entry",sourceResource);
        }
   }
    ...
    */
   public void addTargetInfo(String targetSpecifyAs, String targetNamespacePrefix, String nsLevel, String targetNamespaceURI, String targetResource) throws Exception{
        ESBCommon esbCommon = new ESBCommon(selenium);
        ...
        if (targetSpecifyAs.equals("targetGroupXPath")){
            ...
            esbCommon.addNamespace(targetNamespacePrefix, targetNamespaceURI);
        } else {
            ...
            esbCommon.selectResource("Entry",targetResource);
        }
   }
