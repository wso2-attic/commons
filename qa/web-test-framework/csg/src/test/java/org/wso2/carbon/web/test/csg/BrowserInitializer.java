...
public class BrowserInitializer {
    ...
    public synchronized static void initBrowser()throws Exception{
        ...
        if (browser == null) {
            browser = new DefaultSelenium("localhost", 4444, "*"+loadProperties().getProperty("browser.version"), "https://" + loadProperties().getProperty("host.name") + ":" + loadProperties().getProperty("https.port"));
            browser.start();
