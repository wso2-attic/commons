...
public class ProfileManagement extends TestCase {
    ...
    public void testCSHelp() throws Exception{
        String expectedForCSHelp="https://"+ loadProperties().getProperty("host.name")+":"+loadProperties().getProperty("https.port")+loadProperties().getProperty("context.root")+"/carbon/profilemgt/docs/userguide.html";
        selenium.click("link=Profile Management");
		selenium.waitForPageToLoad("30000");
