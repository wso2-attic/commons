...
//                browser.click("//button[@type='button']");
    ...
    public String tryRDBMSDataService(String ServiceName, String operationName, String SoapAction, String namespace) throws Exception {
        ...
        String serviceepr = "http://" +property.getProperty("host.name") + ":" + property.getProperty("http.port") + property.getProperty("context.root") + "/services/" + ServiceName;
...
//        }
    ...
    public void invokeRestFulService(String serviceName, String productCode) throws Exception {
        ...
        String strURL = "http://localhost:" + property.getProperty("http.port") + property.getProperty("context.root") + "/services/" + serviceName + ".HTTPEndpoint/product/" + productCode;
