...
public class ServiceManagement extends SeleneseTestCase

{
    ...
    public void openServiceDashboard(String serviceName, String serviceType) throws Exception          // Traversing Service Management Page.
    {
        ...
        verifyTrue(browser.isTextPresent("Generate Client"));
    ...
    public void enableSecurityScenario(String serviceName, String scenarioid) throws InterruptedException {
        ...
        if (scenarioid.equals("scenario1")) {
            browser.click("//input[@name='userGroups' and @value='admin']");
            browser.click("//input[@value='Finish']");
            browser.waitForPageToLoad("30000");
            ...
            browser.select("privateStore", "label=qaserver.jks");
            browser.click("//input[@value='Finish']");
            browser.waitForPageToLoad("30000");
        } else {
            browser.click("//input[@name='trustStore' and @value='qaserver.jks']");
...
//        browser.waitForPageToLoad("30000");
    ...
    public void engageServiceModule(String serviceGroupName,String serviceName, String moduleName) throws Exception     // Service level module engage method
    {
        disengageServiceGroupModule(serviceGroupName,  moduleName) ;
        accessServiceDashboard(serviceName);
        ...
        while (browser.isElementPresent("//table[@id='table1']/tbody/tr["+Integer.toString(i)+"]/td")) {
            ...
            if(moduleName.equals(browser.getText("//table[@id='table1']/tbody/tr["+Integer.toString(i)+"]/td"))){
                ...
                verifyTrue(browser.isTextPresent("exact:Do you really want to disengage " + moduleName + " module from " + serviceName + " service ?"));
                browser.click("//button[@type='button']");
                browser.waitForPageToLoad("30000");
                browser.click("//button[@type='button']");
            }
    ...
    public void engageServiceGroupModule(String serviceGroupName, String moduleName) throws Exception {
        ...
        while (browser.isElementPresent("//table[@id='table1']/tbody/tr["+Integer.toString(i)+"]/td")) {
            ...
            if(moduleName.equals(browser.getText("//table[@id='table1']/tbody/tr["+Integer.toString(i)+"]/td"))){
                browser.click("//table[@id='table1']/tbody/tr[" + Integer.toString(i) + "]/td/a/img");
                verifyTrue(browser.isTextPresent("exact:Do you really want to disengage " + moduleName + " module from " + serviceGroupName + " service group"));
                browser.click("//button[@type='button']");
                browser.waitForPageToLoad("30000");
                browser.click("//button[@type='button']");
            }
    ...
    public void checkTransport(String ServiceName) throws Exception {
        ...
        if ("http".equals(protocol)) {
            assertTrue(browser.isTextPresent(http_port));
        }
        if ("https".equals(protocol)) {
            assertTrue(browser.isTextPresent(https_port));
        }
        browser.goBack();
...
//            assertTrue(browser.isTextPresent("exact:Do you want to remove "+protocol2+" binding for this service ?"));
    ...
    public void engageOperationModule(String serviceName, String operationName, String moduleName) throws Exception {
        disengageServiceModule(serviceName,moduleName);
        accessServiceDashboard(serviceName);
        ...
        while (browser.isElementPresent("//table[@id='table1']/tbody/tr["+Integer.toString(i)+"]/td")) {
            ...
            if(moduleName.equals(browser.getText("//table[@id='table1']/tbody/tr["+Integer.toString(i)+"]/td"))){
                browser.click("//table[@id='table1']/tbody/tr[" + Integer.toString(i) + "]/td/a/img");
                verifyTrue(browser.isTextPresent("exact:Do you really want to disengage " + moduleName + " module from " + operationName +" operation"));
                browser.click("//button[@type='button']");
                browser.waitForPageToLoad("30000");
                browser.click("//button[@type='button']");
            }
    ...
    //Enabling Secure RM
    public void enableSecureRMwithConfidentialitySecurityScenario(String serviceName, String nameSpace, String SoapAction, String operation, String param) throws Exception {

        enableSecurityScenario(serviceName, "scenario4");
        enableRM(serviceName);
        int responseCount = new SecureRMClient().runSecureRMClient("scenario4", serviceName, nameSpace, SoapAction, operation, param);
        assertEquals(11, responseCount);
        Thread.sleep(1000);
        disableSecurity(serviceName);
        disableRM(serviceName);
    }
    ...
    public void restartServer() throws Exception{
        ...
        String username = properties.getProperty("admin.username");
    ...
    public void Login() throws Exception{
        ...
        String username = properties.getProperty("admin.username");
        String password =properties.getProperty("admin.password");
        if((browser.isElementPresent("link=Sign-in"))){
        ...
        if(!(browser.isTextPresent("Sign-out"))) {
           InstSeleniumTestBase.loginToUI(username, password);
        }
