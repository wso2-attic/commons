...
//        assertTrue(selenium.isTextPresent("No versions available for this resource or collection."));
    ...
    public void signOut() throws InterruptedException {
        ...
        if (selenium.isElementPresent("link=X")) {
    ...
    public void moveResource(int actionId, String resourcePath, String destinationPath) throws InterruptedException {
    ...
    public void editResource(int actionId, String path, String newResourceName) throws InterruptedException {
...
//        selenium.open("/carbon/resources/resource.jsp?region=region3&item=resource_browser_menu");
    ...
    public void editCollection(int actionId, String destinationPath, String resourceName) throws InterruptedException {
...
//        "'resourceEdit" + actionId + "',1, 'collection');\"]");
    ...
    public void resourceUploadUrlMsg() throws InterruptedException {
        setWindowfocus();
    ...
    public void resourcetextContentMsg() throws InterruptedException {
        setWindowfocus();
        Thread.sleep(1000);
    ...
    public void collectionCreateMsg() throws InterruptedException {
        setWindowfocus();
    ...
    public void symlinkCreateMsg() throws InterruptedException {
        setWindowfocus();
    ...
    public boolean gotoServicePage() throws InterruptedException {
        boolean value = false;
    ...
    public boolean gotoWSDLPage() throws InterruptedException {
        //   boolean value = false;
    ...
    public boolean gotoSchemaPage() throws InterruptedException {
        boolean value = false;
    ...
    public boolean gotoServicesPage() throws InterruptedException {
        boolean value = false;
        Thread.sleep(1000);
    ...
    public boolean gotoPoliciesPage() throws InterruptedException {
        boolean value = false;
        for (int second = 0; ; second++) {
            if (second >= 60) fail("timeout");
            try {
    ...
    public boolean gotoWSDLsPage() throws InterruptedException {
        boolean value = false;
    ...
    public boolean gotoSchemasPage() throws InterruptedException {
        boolean value = false;
    ...
    public boolean gotoMyprofile() throws InterruptedException {
        boolean value = false;
        for (int second = 0; ; second++) {
            if (second >= 60) fail("timeout");
            try {
    ...
    public void createSymlinktoRootResource(String symResourceName, String resourceName) throws InterruptedException {
    ...
    public boolean checkProperties(String key, String propertyValue) throws InterruptedException {
    ...
    public boolean checkComments(String commentValue, String commentedByUser) throws InterruptedException {
    ...
    public boolean checkTags(String tagValue) throws InterruptedException {
    ...
    public boolean checkRating(int ratingValue, double averageRating) throws InterruptedException {
    ...
    public void addAssociationResource(String assoType, String resourceName) throws InterruptedException {
    ...
    public void navigateAssociationUrls(String resourceName, String verifyText) throws InterruptedException {
    ...
    public void navigateAssociationLinks(String resourceName) throws InterruptedException {
...
//                assertTrue(selenium.isTextPresent(resourceName));
    ...
    public void clickAssociationTree() throws InterruptedException {
    ...
    public boolean checkAssociationTree(String resourceName) throws InterruptedException {
    ...
    public boolean checkAssociationTable(String resourceName) throws InterruptedException {
    ...
    public void clickAssocitionTreelinks(String resourceName) throws InterruptedException {
    ...
    public void addExtenalLinkAssociation(String url, String type) throws InterruptedException {
    ...
    public void removeAssociation(String resourceName, String type, String associationLink) throws InterruptedException {
    ...
    public boolean AddSubscribtionsFromPanel(String eventList, String notificationMethodList, String
    ...
    public boolean AddPolicy(String url, String name) throws InterruptedException {
    ...
    public boolean AddWSDL(String url, String name) throws InterruptedException {
...
//        Thread.sleep(1000);
    ...
    public boolean checkWSDL_Exsits(String name) throws InterruptedException {
        gotoWSDLsPage();
        Thread.sleep(500);
    ...
    public boolean checkService_Exsits(String name) throws InterruptedException {
        gotoServicesPage();
        Thread.sleep(500);
        if (selenium.isTextPresent(name))
            return true;
    ...
    public boolean checkSchema_Exsits(String name) throws InterruptedException {
        gotoSchemasPage();
        Thread.sleep(500);
        if (selenium.isTextPresent(name))
            return true;
    ...
    public boolean checkPolicy_Exsits(String name) throws InterruptedException {
        gotoPoliciesPage();
        Thread.sleep(500);
        if (selenium.isTextPresent(name))
            return true;
    ...
    public boolean addSchema(String url, String name) throws InterruptedException {
        gotoSchemaPage();
        selenium.type("irFetchURL", url);
        if (name.equals(null))
            name = selenium.getValue("irResourceName");
    ...
    public boolean checkContentDisplay(String key) throws InterruptedException {
    ...
    public boolean fillProfile(String name, String fName, String lName, String org,
                               String add, String country, String email, String tPhone, String mobileNo,
                               String iM, String url) throws InterruptedException {
...
//            return false;
    ...
    public boolean deletePolicy(String resourceName) throws InterruptedException {
    ...
    public boolean deleteWSDL(String resourceName) throws InterruptedException {
        String path = "";
        gotoWSDLsPage();
        String readResource = "";
        int i = 2;
...
//        selenium.setSpeed(NewSpeed);
    ...
    public boolean deleteService(String resourceName) throws InterruptedException {  // not completed
...
//        selenium.setSpeed(NewSpeed);
    ...
    public boolean deleteSchema(String resourceName) throws InterruptedException { // not completed
        gotoSchemasPage();
        String readResource = "";
        String path = "";
        int i = 2;
...
//        selenium.setSpeed(NewSpeed);
    ...
    public String truncateDirectoryPath(String url) throws InterruptedException {


        return url.replace("\n", "");
    }

    public void addDependency(String resourceName) throws InterruptedException {
    ...
    public void navigateDependencyLinks(String resourceName) throws InterruptedException {
...
//                assertTrue(selenium.isTextPresent(resourceName));
    ...
    public void clickDependencyTree() throws InterruptedException {
    ...
    public boolean checkDependencyTree(String resourceName) throws InterruptedException {
    ...
    public boolean checkDependencyTable(String resourceName) throws InterruptedException {
    ...
    public void clickDependencyTreelinks(String resourceName) throws InterruptedException {
    ...
    public void removeDependency(String sourceResource, String resourceName) throws InterruptedException {
    ...
    public String TruncateResourceName(String s) {
    ...
    public boolean gotoBrowsePage() throws InterruptedException {
        for (int second = 0; ; second++) {
            if (second >= 60) fail("timeout");
            try {
...
//        }
    ...
    public boolean deleteAllSchemas() throws InterruptedException { // not completed
    ...
    public boolean deleteAllServices() throws InterruptedException { // not completed
    ...
    public boolean deleteAllWsdls() throws InterruptedException { // not completed
    ...
    public boolean deleteAllPolicies() throws InterruptedException { // not completed
    ...
    public int countDependencies() throws InterruptedException {
        selenium.click("dependenciesIconMinimized");
    ...
    public int countAssociations() throws InterruptedException {
        selenium.click("associationsIconMinimized");
    ...
    public boolean addLifeCycle(String lifeCycleName) throws InterruptedException {
...
//        }
    ...
    public boolean tickCheckList() throws InterruptedException {
    ...
    public boolean promoteLC() throws InterruptedException {
        if (selenium.isElementPresent("lifecycleIconMinimized"))
            selenium.click("lifecycleIconMinimized");
        Thread.sleep(1000);
    ...
    public boolean demoteLC() throws InterruptedException {
        if (selenium.isElementPresent("lifecycleIconMinimized"))
            selenium.click("lifecycleIconMinimized");
        Thread.sleep(1000);
    ...
    public boolean deleteLifeCycle() throws InterruptedException {
        if (selenium.isElementPresent("lifecycleIconMinimized"))
    ...
    public boolean registerProfile(String userName, String mediaType) throws InterruptedException {
        gotoBrowsePage();
        Thread.sleep(500);
        selenium.click("link=Add Resource");
        selenium.select("addMethodSelector", "label=Create custom content");
...
//        selenium.wait(1000);
    ...
    public boolean deleteColletion(String path, String name) throws InterruptedException {
...
//        System.out.println(id) ;
    ...
    public void checkProfileRegister(String path, String profileName, String fName, String lName, String email) throws InterruptedException {
...
//      assertTrue(selenium.isTextPresent());   // if u want to add more details change this
    ...
    public boolean checkPropertiesOfWSDL(String propertyName, String propertyValue) throws InterruptedException {
    ...
    public boolean deleteProfile(String profileName, String user) throws InterruptedException {
        gotoMyprofile();
    ...
    public boolean gotoOtherUsersProfiles(String username) throws InterruptedException {
        int i = 1;
    ...
    public int getId(String resourceName) throws InterruptedException {
        int i = 1;
        while (selenium.isElementPresent("//td[@id='actionPaneHelper" + i + "']/table/tbody/tr/td[1]")) {
    ...
    public boolean addNotificationFromAdminConsole(String subPath, String eventList, String notificationMethodList, String
...
//            return false;
    ...
    public boolean selectPathFromResourceTree(String path) throws InterruptedException { // this metod works oly in the
...
//        selenium.setSpeed(NewSpeed);
    ...
    public boolean fillServiceOverview(String name, String nameSpace, String states, String description) { // fill the
    ...
    public boolean fillServiceContacts(String contact1, String contacttype1, String contact2,
                                       String contacttype2, String contact3, String contacttype3) {
    ...
    public boolean fillServiceInterface(String wsdlUrl, String transportProtocol, String messageFormat, String messageExchangePattern) {
        selenium.type("wsdlURL", wsdlUrl);
    ...
    public boolean fillServiceSecurity(String authenticationplatform, String authenticationmechanism, String authorizationPlatform,
                                       String messageIntegrity, String messageEncryption, String comments) {
    ...
    public boolean fillServiceEndpoint(String enviroment, String url) {
        int i = 1;
    ...
    public boolean fillServiceDocLinks(String doctype1, String url1, String comment1,
                                       String doctype2, String url2, String comment2, String doctype3, String url3, String comment3) {
    ...
    public boolean saveService() throws InterruptedException {
    ...
    public boolean addNewRole(String roleName, String configuration) throws InterruptedException {
    ...
    public boolean addUserToRole(String roleName, String userName) throws Exception {
        int i = 1;
        selenium.click("link=User Management");
        selenium.waitForPageToLoad("30000");
        selenium.click("link=Roles");
...
//    public  boolean setUserPermissions()
    ...
    public boolean setRolePermissions(String roleName, String authorize, boolean allow) throws InterruptedException {
        boolean value = false;
        gotoBrowsePage();
        Thread.sleep(1000);
...
//        selenium.setSpeed(NewSpeed);
    ...
    public boolean gotoNotificationPage() throws InterruptedException {
        for (int second = 0; ; second++) {
    ...
    public void gotoUserManagementPage() throws InterruptedException {
        for (int second = 0; ; second++) {
            if (second >= 20) fail("timeout");
            try {
    ...
    public void gotoRolePage() throws InterruptedException {
        gotoUserManagementPage();
        for (int second = 0; ; second++) {
            if (second >= 60) fail("timeout");
            try {
    ...
    public boolean deleteRole(String userName) throws InterruptedException {
        int i = 1;
        boolean found = false;
        gotoRolePage();
//        selenium.setSpeed(NewSpeed);
    ...
    public boolean deleteAllNotifications() throws InterruptedException {
    ...
    public boolean editNotification(String path, String event, String notification, String subsInput, String newEvent, String newNotification, String newSubsInput) throws InterruptedException {
        int id = 0;
        String transNotific;
        gotoNotificationPage();
...
//        System.out.println(prevEvent +"*"+ prevNotific +"*"+prevSubInput );
    ...
    public int searchNotification(String path, String event, String notification, String subscriptionInput) throws InterruptedException {
        int i = 1;
        boolean found = false;
//        selenium.setSpeed(NewSpeed);
        Thread.sleep(1000);
...
//                        selenium.goBack() ;
    ...
    public void gotoLifeCyclePage() throws InterruptedException {
        for (int second = 0; ; second++) {
            if (second >= 60) fail("timeout");
            try {
    ...
    public boolean viewLC(String name) throws InterruptedException {
        gotoLifeCyclePage();
        int id;
        id = getLCId(name);
...
//        selenium.waitForPageToLoad("30000");
    ...
    public boolean deleteLC(String name) throws InterruptedException {
        gotoLifeCyclePage();
        int id;
        id = getLCId(name);
...
//        selenium.waitForPageToLoad("30000");
    ...
    public int getLCId(String name) throws InterruptedException {
        int i = 1;
    ...
    public boolean editLC(String name, String newContent) throws InterruptedException {
        gotoLifeCyclePage();
        int id;
        id = getLCId(name);
...
//        selenium.waitForPageToLoad("30000");
    ...
    public boolean addNewLC(String name, String content) throws InterruptedException {
        gotoLifeCyclePage();
    ...
    public int countLCs() throws InterruptedException {
        gotoLifeCyclePage();
        int i = 1;
        while (selenium.isElementPresent("//table[@id='lcmTable']/tbody/tr[" + (i++) + "]/td[1]")) ;
        return i - 1;
    ...
    public void deleteLCFromBrowser() throws InterruptedException {
        if (selenium.isElementPresent("lifecycleIconMinimized"))
            selenium.click("lifecycleIconMinimized");
        selenium.click("link=Delete");
        for (int second = 0; ; second++) {
    ...
    public boolean gotopath(String path, String res) throws InterruptedException {
        gotoBrowsePage();
...
//            System.out.println(path.substring(a+1,b));
    ...
    public void addUserPerm(String user, String actToAuth, boolean auth) throws InterruptedException {
        selenium.click("perIconMinimized");
        ...
        for (int second = 0; ; second++) {
            if (second >= 60) fail("timeout");
            try {
                if ("Permission applied successfully".equals(selenium.getText("//div[@id='messagebox-info']/p"))) break;
            } catch (Exception e) {
            }
            Thread.sleep(1000);
        }
    ...
    public void gotoActivityPage() throws InterruptedException {
        for (int second = 0; ; second++) {
            if (second >= 60) fail("timeout");
            try {
    ...
    public boolean searchActivity(String usrName, String path, String dateFrom, String dateTo, String filterBy, String searchTag) throws InterruptedException {
        int i = 1;
        gotoActivityPage();
    ...
    public boolean moveCollection(String colectionName, String sourcePath, String destiPath) throws InterruptedException {
        int id;
    ...
    public String convertNamespaceToFolderStructure(String nameSpace) throws InterruptedException {
    ...
    public boolean copyCollecion(String name, String sourcePath, String destinationPath) throws InterruptedException {
        int id;
    ...
    public boolean addResFromLocalFS(String path, String name) throws InterruptedException {
        selenium.click("link=Add Resource");
        selenium.type("uResourceFile", path);
        Thread.sleep(10000);
...
//        System.out.println(id) ;
    ...
    public boolean cleanRegistry() throws InterruptedException {  // if u need  anything not to delete put that
    ...
    public boolean search(String resName, String createdFrom, String createdTo, String updatedFrom, String updatedTo,
                          String createdBy, String updatedBy, String tags, String comments, String propertyName, String propVal, String path, String author) throws InterruptedException {
...
//        Thread.sleep(2000);
    ...
    public boolean gotoSearchPage() throws InterruptedException {
        for (int second = 0; ; second++) {
            if (second >= 60) fail("timeout");
            try {
    ...
    public boolean clickSearchAgain() throws InterruptedException {
    ...
    public boolean cleanSearchFields() throws InterruptedException {
    ...
    public  void addcomment(String comment,String path) throws InterruptedException {
        selenium.click("commentsIconMinimized");
        selenium.click("link=Add Comment");
    ...
    public void verifyFeedResources(String resources[]) {
    ...
    public void testCleanRegistry() throws InterruptedException {  // if u need  anything not to delete put that
        // name to the "folder" array
        String[] folders = {"carbon", "governance", "system"};
        boolean shouldNotDelete = false;
        String name = "";
    ...
    public boolean uploadPicShtBg(String fileName,String name,String description) throws Exception {
    ...
    public String getProperty(String propertyName)throws InterruptedException {
        int i=0;
        selenium.click("propertiesIconMinimized");
        while(selenium.isElementPresent("//tr[@id='propViewPanel_"+i+"']/td[1]")){
    ...
    public void managePopupInShutterbugBrowser() throws InterruptedException {
    ...
    public boolean exploreThroughPaging(String path, String res) throws InterruptedException {
        int index = 0;
        boolean run=true;
        int loop=0;
        int a, b;
...
//            System.out.println(path.substring(a+1,b));
    ...
    public boolean createCheckPoint() throws InterruptedException {
    ...
    public void clickViewVerions() throws InterruptedException {
        selenium.click("link=View versions");
        selenium.waitForPageToLoad("120000");
    }
    public boolean checkVersionDetails(int version,String resources[]) throws InterruptedException{
        int i=1,index=0;
        boolean found=false;
        clickViewVerions();
    ...
    public boolean restoreVersion(int version) throws InterruptedException {
        int i=1;
        boolean found=false;
        clickViewVerions();
        while(selenium.isElementPresent("//table[@id='versionsTable']/tbody/tr["+i+"]/td[1]")){
...
//        selenium.waitForPageToLoad("120000");
        for (int second = 0;; second++) {
            if (second >= 60) fail("timeout");
            try { if (selenium.isElementPresent("messagebox-info")) break; } catch (Exception e) {}
            Thread.sleep(1000);
        }
    ...
    public boolean checkVersionResourceProperties(int version,String resource,String key,String property) throws InterruptedException{
        int i=1;
        boolean found=false;
        clickViewVerions();
        while(selenium.isElementPresent("//table[@id='versionsTable']/tbody/tr["+i+"]/td[1]")){
    ...
    public void openResourceInMetaData(String name) throws InterruptedException{
        selenium.click("link="+name);
        selenium.waitForPageToLoad("120000");
    }
    public boolean checkVersionResourceComments(int version,String resource,String comment, String user) throws InterruptedException{
        int i=1;
        boolean found=false;
        clickViewVerions();
        while(selenium.isElementPresent("//table[@id='versionsTable']/tbody/tr["+i+"]/td[1]")){
    ...
    public boolean checkVersionResourceTags(int version,String resource,String tag) throws InterruptedException{
        int i=1;
        boolean found=false;
        clickViewVerions();
        while(selenium.isElementPresent("//table[@id='versionsTable']/tbody/tr["+i+"]/td[1]")){
    ...
    public boolean checkVersionResourceRating(int version,String resource,int ratingVal,double avgRating) throws InterruptedException{
        int i=1;
        boolean found=false;
        clickViewVerions();
        while(selenium.isElementPresent("//table[@id='versionsTable']/tbody/tr["+i+"]/td[1]")){
    ...
    public void editResourceContent(String txt) throws InterruptedException {
    ...
    public boolean checkResourceContent(String txt) throws InterruptedException {
        selenium.click("link=Display as text");
        Thread.sleep(2000);
        if(selenium.isElementPresent("messagebox-warning")) {
             selenium.click("//button[@type='button']");
    ...
    public boolean checkVersionResourceContent(int version,String resource,String txt) throws InterruptedException{
        int i=1;
        boolean found=false;
        clickViewVerions();
        while(selenium.isElementPresent("//table[@id='versionsTable']/tbody/tr["+i+"]/td[1]")){
