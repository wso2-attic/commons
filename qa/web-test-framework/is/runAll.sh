...
###################################################">> reports/surefire_report.txt
	cat target/surefire-reports/org.wso2.carbon.web.test.is.AllTests.txt >> reports/surefire_report.txt


	egrep "Tests run:"  target/surefire-reports/org.wso2.carbon.web.test.is.AllTests.txt > reports/tmp.txt
