...
public class ISUserManagementTest extends TestCase {
    ...
    public void testCheckPermission1() throws Exception    //Login to admin console
    {
        ...
        browser.click("link=My Profiles");
		browser.waitForPageToLoad("30000");
		assertTrue(browser.isTextPresent("My Profiles"));
		browser.click("link=InfoCard/OpenID");
		browser.waitForPageToLoad("30000");
		assertTrue(browser.isTextPresent("InfoCard/OpenID Dashboard"));
		browser.click("link=Relying Parties");
		browser.waitForPageToLoad("30000");
		assertTrue(browser.isTextPresent("InfoCard/OpenID - Trusted Relying Parties"));
		browser.click("link=Multifactor Authentication");
		browser.waitForPageToLoad("30000");
		assertTrue(browser.isTextPresent("Multifactor Authentication Configurations"));
    }
    ...
    public void testCheckPermission2() throws Exception    // manage-configuration
    {
		...
		browser.waitForPageToLoad("30000");
		assertTrue(browser.isTextPresent("User Entitlement"));
		browser.click("link=Card Issuer");
		browser.waitForPageToLoad("30000");
		assertTrue(browser.isTextPresent("Card Issuer Configuration"));
    ...
    public void testCheckPermission3() throws Exception  //manage-security
    {
		...
		browser.click("link=XKMS");
		browser.waitForPageToLoad("30000");
		assertTrue(browser.isTextPresent("XKMS Configuration"));
		browser.click("link=My Profiles");
		browser.waitForPageToLoad("30000");
		assertTrue(browser.isTextPresent("My Profiles"));
		browser.click("link=InfoCard/OpenID");
