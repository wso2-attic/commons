...
public class StartUpTest extends TestCase {
    ...
    public void ErorrsInStartUp(String logName) throws Exception{
        String line = null;
        File file=new File(carbonHome + File.separator + "repository" + File.separator + "logs" + File.separator + logName);

        if(file.exists()){
            try {
                BufferedReader br = new BufferedReader(new FileReader(carbonHome +  File.separator + "repository" + File.separator + "logs" + File.separator + logName));
                try {
