...
public class RMClient {
    ...
    public int RMRequestReplyAnonClient(String serviceName, String soapversion, String SoapAction, String NameSpace, String operation, String param) throws Exception {
        ...
        int count = 0;
        ConfigurationContext cc = ConfigurationContextFactory.createConfigurationContextFromFileSystem(loadProperties().getProperty("carbon.home") + File.separator + "repository" + File.separator + "deployment" + File.separator + "client", null);
    ...
    public int RMRequestReplyAddressableClient(String serviceName, String soapversion, String SoapAction, String NameSpace, String operation, String param) throws Exception {
        ...
        int count = 0;
        ConfigurationContext cc = ConfigurationContextFactory.createConfigurationContextFromFileSystem(loadProperties().getProperty("carbon.home") + File.separator + "repository"+ File.separator + "deployment" + File.separator + "client", ".." + File.separator + "commons" + File.separator + "src" + File.separator + "test" + File.separator + "client-repository" + File.separator + "conf" + File.separator + "axis2.xml");
        ServiceClient sc = new ServiceClient(cc, null);
