...
public class SecureRMClient implements CallbackHandler {

    public int runSecureRMClient(String scenarioid, String serviceName, String Namespace, String SoapAction, String operation, String param) throws Exception {
...
//        }
    ...
    public OMElement CreateRequestReplyPayload(String NameSpace, String operation, String param) throws Exception {
        ...
        value.addChild(fac.createOMText(value, "Invoking Secure RM Scenario!!!!"));
        OP1.addChild(value);
        return OP1;
    }
