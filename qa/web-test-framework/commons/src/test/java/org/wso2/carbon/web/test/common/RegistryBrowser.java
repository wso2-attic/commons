...
public class RegistryBrowser extends TestCase {
    ...
    public void testImportMetaDataFromFS() throws Exception {
        ...
        Thread.sleep(1000);
        importResourceFromFSFailure("file://" + path + "/lib/resources/Screenshot-1.png");
        UmCommon.logOutUI();
    }

    private void importResourceFromFSFailure(String url)
...
//        stb.loginToUI("admin", "admin");
    ...
    public void testAnonymousAccessHttps() throws Exception {
        ...
        String url = "https://" + properties.getProperty("host.name") + ":" + properties.getProperty("https.fe.port") + "";
        ...
        System.out.println(constructedUrl + resourceName);
        selenium.open(constructedUrl + resourceName);
        selenium.waitForPageToLoad("30000");
        assertTrue(selenium.isTextPresent("HTTP Status 500"));

        String feedWinId1 = selenium.getEval("{var windowId; for(var x in selenium.browserbot.openedWindows ) {windowId=x;} }");
        selenium.selectWindow(feedWinId1);

        UmCommon.signOutSecurityTest(adminUserName, adminPassword);
        ...
        String feedWinId3 = selenium.getEval("{var windowId; for(var x in selenium.browserbot.openedWindows ) {windowId=x;} }");
        selenium.selectWindow(feedWinId3);
        ...
        String feedWinId4 = selenium.getEval("{var windowId; for(var x in selenium.browserbot.openedWindows ) {windowId=x;} }");
        selenium.selectWindow(feedWinId4);
    ...
    public void testAnonymousAccessHttp() throws Exception {
        ...
        String url = "http://" + properties.getProperty("host.name") + ":" + properties.getProperty("http.fe.port") + "";
        System.out.println("XXX" + url);
        ...
        String feedWinId2 = selenium.getEval("{var windowId; for(var x in selenium.browserbot.openedWindows ) {windowId=x;} }");
        selenium.selectWindow(feedWinId2);
    ...
    public void testAnymousAccessSystem() throws Exception {
        ...
        String http_url = "http://" + properties.getProperty("host.name") + ":" + properties.getProperty("http.fe.port") + "";
        String https_url = "https://" + properties.getProperty("host.name") + ":" + properties.getProperty("https.fe.port") + "";
...
//        registryCommon.deleteResource(resourceName, actionIdRes);
    ...
    public void testAnonymousAccessSetPermissionDeny() throws Exception {
        ...
        String feedWinId5 = selenium.getEval("{var windowId; for(var x in selenium.browserbot.openedWindows ) {windowId=x;} }");
        selenium.selectWindow(feedWinId5);
        ...
        String feedWinId6 = selenium.getEval("{var windowId; for(var x in selenium.browserbot.openedWindows ) {windowId=x;} }");
        selenium.selectWindow(feedWinId6);
    ...
    public void testAnonymousAccessSetPermissionToRoot() throws Exception {
        ...
        System.out.println(constructedUrlhttp);
        System.out.println(constructedUrlhttps);
        String resourceName = "/testAnoumousAccessSetPermissionDeny";
        registryCommon.gotoResourcePage();
