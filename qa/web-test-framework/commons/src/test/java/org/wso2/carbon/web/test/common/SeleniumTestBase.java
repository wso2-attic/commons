...
//            Thread.sleep(8000);
        ...
        for (int second = 0; ; second++) {
            ...
            try {
                if (browser.isElementPresent("txtUserName")) break;
            } catch (Exception e) {
            }
            Thread.sleep(1000);
        }
    ...
    /* signOutSecurityTest method will only be use to test security fix test scenarios */

    public void signOutSecurityTest(String UserName, String Password) throws InterruptedException, IOException {

        if (browser.isElementPresent("link=Sign-out") || browser.isElementPresent("@")) {
            ...
            for (int second = 0; ; second++) {
                ...
                try {
                    if (browser.isTextPresent("Sign-in")) break;
                } catch (Exception e) {
                }
                Thread.sleep(1000);
            }
...
//            Thread.sleep(8000);
                ...
                if (browser.isTextPresent("Sign-in")) {
                    for (int second = 0; ; second++) {
                        if (second >= 50) fail("timeout");
                        try {
                            if (browser.isElementPresent("txtUserName")) ;
                            break;
    ...
    public void logOutUI() throws InterruptedException {
        ...
        for (int second = 0; ; second++) {
            ...
            try {
                if (browser.isElementPresent("link=Sign-out")) break;
            } catch (Exception e) {
            }
            Thread.sleep(1000);
        }
...
//        browser.click("//button[@type='button']");
    ...
    public void addNewRole(String RoleName, String AsignUser, String Permission1) throws Exception   // Create New internal user store
    {
        ...
        */
        ...
        } else if (Permission1 == "manage-security"){

            browser.click("selectedPermissions");
            browser.click("//input[@name='selectedPermissions' and @value='" + Permission1 + "']");
		    browser.click("//input[@name='selectedPermissions' and @value='manage-services']");
        }
