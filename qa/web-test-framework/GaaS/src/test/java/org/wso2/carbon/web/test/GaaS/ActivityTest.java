...
public class ActivityTest extends CommonSetup{
    ...
    public void testRenameCollectionByDefAdmin() throws Exception {
        ...
        String path="/";
        String searchTag=user+" has renamed the resource to "+path+collectionNewName+" from old Name: "+path+collectionName ;
        registryCommon.signOut();
        UmCommon.loginToUI(adminUserName, adminPassword);
        registryCommon.cleanRegistry() ;
        registryCommon.gotoBrowsePage();
    ...
    public void testMoveCollectionByDefAdmin() throws Exception {
        ...
        String searchTag=user+" has moved the resource to "+newpath +path+collectionName+" from the Location "+path+collectionName;
        registryCommon.signOut();
        UmCommon.loginToUI(adminUserName, adminPassword);
        registryCommon.cleanRegistry() ;
        registryCommon.gotoBrowsePage();
    ...
    public void testCopyCollectionByDefAdmin() throws Exception {
        ...
        String path="/";
        String searchTag=user+" has copied the resource "+path+collectionName+" to the Location "+path+copiedPath+"/"+collectionName ;
        registryCommon.signOut();
        UmCommon.loginToUI(adminUserName, adminPassword);
        registryCommon.cleanRegistry() ;
        registryCommon.gotoBrowsePage();
    ...
    public void testRenameResourceByDefAdmin() throws Exception {
        ...
        String path="/";
        String searchTag=user+" has renamed the resource to "+path+resourceNewName+" from old Name: "+path+resourceName ;
        registryCommon.signOut();
        UmCommon.loginToUI(adminUserName, adminPassword);
        registryCommon.cleanRegistry() ;
        registryCommon.gotoBrowsePage();
    ...
    public void testMoveResourceByDefAdmin() throws Exception {
        ...
        String searchTag=user+" has moved the resource to " +newpath+path+resourceName+" from the Location "+path+resourceName;
        registryCommon.signOut();
        UmCommon.loginToUI(adminUserName, adminPassword);
        registryCommon.cleanRegistry() ;
        registryCommon.gotoBrowsePage();
    ...
    public void testCopyResourceByDefAdmin() throws Exception {
        ...
        String searchTag=user+" has copied the resource "+path+resourceName +" to the Location "+path+copyCollection+"/"+resourceName ;
        registryCommon.signOut();
        UmCommon.loginToUI(adminUserName, adminPassword);
        registryCommon.cleanRegistry() ;
        registryCommon.gotoBrowsePage();
