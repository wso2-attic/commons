...
public class DependencyTest extends TestCase {
   ...
   public DependencyTest (String msg) {
       super(msg) ;
   }
    ...
    public void testDependencyUiValidation() throws Exception {
        ...
        selenium.click("//input[@value='..' and @type='button' and @onclick=\"showResourceTree('depPaths', 'addDependency');\"]");
...
//        selenium.click("//input[@value='Add' and @type='button' and @onclick=\"addAssociation('depForm');\"]");
        selenium.click("//input[@value='Add' and @type='button' and @onclick='addDependency();']");
