...
//        String email="test@wso2.com";
        String name = "test profileAddNotificationAdmin_LCI_Email";
    ...
    public void testAddNotificationAdmin_CC_Email() throws Exception {
        ...
        String notification = "E-mail";
//        String email="test@wso2.com";
        String name = "test profileAddNotificationAdmin_CC_Email";
        String fName = "test fname";
        String lName = "test lname";
        String org = "WSO2";
        String add = "59,Flower rd,Col 7";
    ...
    public void testAddNotificationAdmin_DC_Email() throws Exception {
        ...
        String notification = "E-mail";
//        String email="test@wso2.com";
        String name = "test profileAddNotificationAdmin_DC_Email";
        String fName = "test fname";
        String lName = "test lname";
        String org = "WSO2";
        String add = "59,Flower rd,Col 7";
        ...
        String configuration[] = {"All Permissions"};
    ...
    public void testAddNotificationAdmin_CLCStat_Email() throws Exception {
        ...
        String notification = "E-mail";
//        String email="test@wso2.com";
        String name = "test profileAddNotificationAdmin_CLCStat_Email";
        String fName = "test fname";
        String lName = "test lname";
        String org = "WSO2";
        String add = "59,Flower rd,Col 7";
    ...
    public void testAddNotificationAdmin_Updat_Email() throws Exception {
        ...
        String notification = "E-mail";
//        String email="test@wso2.com";
        String name = "test profileAddNotificationAdmin_Updat_Email";
        String fName = "test fname";
        String lName = "test lname";
        String org = "WSO2";
        String add = "59,Flower rd,Col 7";
    ...
    public void testfinalize() throws Exception {
        ...
        String profileName1 = "test profileAddNotificationAdmin_CLCStat_Email";
        String profileName2 = "test profileAddNotificationAdmin_CLCStat_Email";
        ...
        registryCommon.deleteProfile(profileName1, "admin");
        registryCommon.deleteProfile(profileName2, "admin");
        UmCommon.logOutUI();
