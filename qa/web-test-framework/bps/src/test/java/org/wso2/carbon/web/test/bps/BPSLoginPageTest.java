...
public class BPSLoginPageTest extends CommonSetup {
    ...
    public void testBPSLoginPageUI() throws InterruptedException {
        ...
        assertEquals("Project: WSO2 Business Process Server (WSO2 BPS)",browser.getText("//div[@id='page-middle-noright']/h1"));
        browser.close();
        browser.selectWindow("");
...
//        browser.selectWindow("");
        ...
        browser.waitForPageToLoad("30000");
        assertEquals("WSO2 Project Mailing Lists", browser.getText("//div[@id='page-middle-noright']/h1"));
		browser.close();
        browser.selectWindow("");
