...
public class CSVDataServiceManagementTest extends TestCase {
    ...
    public void testCopyFromRepositorytoLib() throws Exception{
        String carbonHome= property.getProperty("carbon.home");
    ...
    public void testCheckThrottlingCSVDataService() throws Exception {
        ...
        String serviceepr = "http://" + property.getProperty("host.name") + ":" +property.getProperty("http.be.port") + property.getProperty("context.root") + "/services/" + "CSVDataService";
