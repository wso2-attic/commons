...
public class EXCELDataServiceManagementTest extends TestCase{
    ...
    public void testCheckThrottlingExcelDataService() throws Exception {
        ...
        String serviceepr = "http://" + loadProperties().getProperty("host.name") + ":" + loadProperties().getProperty("http.be.port") + loadProperties().getProperty("context.root") + "/services/" + "EXCELDataService";
        instServiceManagement.checkThrottling(serviceepr, "getAllStudents", "urn:getAllStudents", "http://ws.wso2.org/dataservice", "s");


    }

//        public void testCheckCachingExcelDataService() throws Exception {   //caching need not be checked in EXCEL
//
//
//            ServiceManagement instServiceManagement = new ServiceManagement(browser);
//            instServiceManagement.Login();
//            instServiceManagement.accessServiceDashboard("EXCELDataService");
//            String serviceepr = "http://" + loadProperties().getProperty("host.name") + ":" + loadProperties().getProperty("http.port") + loadProperties().getProperty("context.root") + "/services/" + "EXCELDataService";
//            instServiceManagement.checkCaching(serviceepr, "getAllStudents", "urn:getAllStudents", "http://ws.wso2.org/dataservice");
//
//        }
...
//        public void testOperationalCachingExcelDataService() throws Exception {   //caching need not be checked in EXCEL
//
//
//            ServiceManagement instServiceManagement = new ServiceManagement(browser);
//            String serviceepr = "http://" + loadProperties().getProperty("host.name") + ":" + loadProperties().getProperty("http.port") + loadProperties().getProperty("context.root") + "/services/" + "EXCELDataService";
...
//        }
    ...
    public void testMTOMExcelDataService() throws Exception {
        ...
        insServiceManagement.changeOperationalMTOM("EXCELDataService", "getAllStudents", "True");
        Thread.sleep(1000);
        insServiceManagement.changeOperationalMTOM("EXCELDataService", "getAllStudents", "Optional");
        Thread.sleep(1000);
        insServiceManagement.changeOperationalMTOM("EXCELDataService", "getAllStudents", "False");
        Thread.sleep(1000);
        insServiceManagement.changeServiceGroupMTOM("EXCELDataService", "True");
        Thread.sleep(1000);
        insServiceManagement.changeServiceGroupMTOM("EXCELDataService", "Optional");
        Thread.sleep(1000);
        insServiceManagement.changeServiceGroupMTOM("EXCELDataService", "False");
        Thread.sleep(1000);
