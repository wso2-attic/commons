...
public class LoggingTest extends CommonSetup {
    ...
    public void testRun() throws Exception {
        ...
        /*CSHelp*/
        Thread.sleep(1000);
      String expectedForCSHelp="https://"+GSCommon.loadProperties().getProperty("host.name")+":"+GSCommon.loadProperties().getProperty("https.port")+"/carbon/log-admin/docs/userguide.html";
