...
public class KeyStoreTest extends CommonSetup {
    ...
    public void testAddKeyStore() throws Exception {
        ...
        File path = new File(".." + File.separator + "mashup" + File.separator + "lib" + File.separator + "service.jks");
        instKeyStoreManagement.AddKeystore(path.getCanonicalPath(), "testing");
    }

    public void testImportCertificate() throws Exception {
        KeyStoreManagement instKeyStoreManagement = new KeyStoreManagement(selenium);
        File path = new File(".." + File.separator + "mashup" + File.separator + "lib" + File.separator + "mashup.cert");
        instKeyStoreManagement.ImportCertificate(path.getCanonicalPath(), "mashup.cert");
    }
    ...
    public void testInvalidCertificate() throws Exception {
        ...
        File path = new File(".." + File.separator + "mashup" + File.separator + "lib" + File.separator + "PojoService.class");
