...
public class BrowserInitializer {
    ...
    public synchronized static void initBrowser() throws Exception {
        if (browser == null) {
            System.out.println("https://" + property.getProperty("host.name") + ":" + property.getProperty("https.fe.port"));
            browser = new DefaultSelenium("localhost", 4444, "*firefox", "https://" + property.getProperty("host.name") + ":" + property.getProperty("https.fe.port"));
