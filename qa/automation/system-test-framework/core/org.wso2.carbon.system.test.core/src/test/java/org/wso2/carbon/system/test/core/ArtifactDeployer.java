...
public class ArtifactDeployer {
    ...
    protected static Map<Integer, String> productMap;
    protected static MultiValueMapUtil<String, String> jarArtifactMap;
    protected static MultiValueMapUtil<String, String> marArtifactMap;
    protected static MultiValueMapUtil<String, String> garArtifactMap;
    protected static MultiValueMapUtil<String, String> carArtifactMap;
    protected static MultiValueMapUtil<String, String> aarArtifactMap;
    protected static MultiValueMapUtil<String, String> xmlArtifactMap;
    protected static MultiValueMapUtil<String, String> warArtifactMap;
    ...
    private static void warFileUploder(String sessionCookie, String hostName, String filePath) {
        AdminServiceWebAppAdmin AdminServiceWebAppAdmin = new AdminServiceWebAppAdmin(hostName);
    ...
    protected static String getArtifactNameString(String str) {
