...
public class UsagePlanDowngradeTest extends TestTemplate {
    ...
    @Override
    public void init() {
        testClassName = UsagePlanDowngradeTest.class.getName();
    ...
    public void cleanup() {
        ...
        assertEquals("Usage plan doesn't get updated", ProductConstant.MULTITENANCY_FREE_PLAN,
                billingDataAccessStub.getUsagePlanName(sessionCookie, tenantAdminDetails.getTenantDomain()));
