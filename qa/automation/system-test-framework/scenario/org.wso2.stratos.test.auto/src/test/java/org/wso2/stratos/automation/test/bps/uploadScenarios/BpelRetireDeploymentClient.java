...
public class BpelRetireDeploymentClient extends TestTemplate {
    ...
    public void init() {
        ...
        testClassName = BpelRetireDeploymentClient.class.getName();
    ...
    public void runSuccessCase() {
         assertTrue("Process State is still Active", bpelProcrss.getStatus(bpelProcrss.getProcessId("HelloWorld-retire")).equals("RETIRED".toUpperCase()));
    }
