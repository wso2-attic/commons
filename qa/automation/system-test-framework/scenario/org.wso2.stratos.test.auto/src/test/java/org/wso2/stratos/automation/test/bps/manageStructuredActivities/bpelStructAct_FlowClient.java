...
public class bpelStructAct_FlowClient extends TestTemplate {
    ...
    public void init() {
        ...
        bpelUploader.deployBPEL("TestFlowLinks", "TestFlowLinks", sessionCookie);
    }
