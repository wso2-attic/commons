...
public class bpelActIgnoreMissingFromData extends TestTemplate {
    String sessionCookie = null;
    private static final Log log = LogFactory.getLog(bpelActIgnoreMissingFromData.class);
    ...
    public void init(){
        ...
        testClassName = bpelActIgnoreMissingFromData.class.getName();
