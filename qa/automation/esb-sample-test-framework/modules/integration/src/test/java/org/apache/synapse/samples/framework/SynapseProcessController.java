...
public class SynapseProcessController implements ProcessController {
    ...
    private ServerStartupManager serverStartupManager;
    private int sampleID;
    private ServerShutDownManager serverShutdownManager;
    ...
    public SynapseProcessController(SynapseServerConfiguration configuration) {
        ...
        serverStartupManager = new ServerStartupManager();
        serverShutdownManager = new ServerShutDownManager();
        sampleID = -1;
    }

    public boolean startProcess(int sampleID) {
    ...
    private class ServerThread extends Thread {
        ...
        public void run() {
            ...
            try {
                serverStartupManager.start(sampleID);
//                 serverStartupManager.init(information, null);
            ...
            try {
                serverShutdownManager.shutdownServer();
