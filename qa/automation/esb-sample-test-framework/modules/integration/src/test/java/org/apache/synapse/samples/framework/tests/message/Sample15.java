...
public class Sample15 extends SynapseTestCase {
    ...
    public void testMessageEnrichment() {
        ...
        if (PropertyLoader.CONTEXT_ROOT == null) {
            trpUrl = "http://" + PropertyLoader.HOST_NAME + ":" + PropertyLoader.NHTTP_PORT + "/services/StockQuote";
        } else {
            trpUrl = "http://" + PropertyLoader.HOST_NAME + ":" + PropertyLoader.NHTTP_PORT + "/" + PropertyLoader.CONTEXT_ROOT + "/services/StockQuote";
        }
