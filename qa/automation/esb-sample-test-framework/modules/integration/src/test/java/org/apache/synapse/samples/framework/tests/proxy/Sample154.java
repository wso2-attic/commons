...
public class Sample154 extends SynapseTestCase {
    ...
    public void testSessionFullLB() {
        ...
        if (PropertyLoader.CONTEXT_ROOT == null) {
            trpUrl = "http://" + PropertyLoader.HOST_NAME + ":" + PropertyLoader.NHTTP_PORT + "/services/LBProxy";
        } else {
            trpUrl = "http://" + PropertyLoader.HOST_NAME + ":" + PropertyLoader.NHTTP_PORT + "/" + PropertyLoader.CONTEXT_ROOT + "/services/LBProxy";
        }
