...
public class Sample152 extends SynapseTestCase {
    ...
    public void testTransportAndFormatSwitching() {
        ...
        if (PropertyLoader.CONTEXT_ROOT == null) {
            url2 = "https://" + PropertyLoader.HOST_NAME + ":" + PropertyLoader.NHTTPS_PORT + "/services/StockQuoteProxy";
        } else {
            url2 = "https://" + PropertyLoader.HOST_NAME + ":" + PropertyLoader.NHTTPS_PORT + "/" + PropertyLoader.CONTEXT_ROOT + "/services/StockQuoteProxy";
        }
