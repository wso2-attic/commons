...
public class Sample370 extends SynapseTestCase {
    ...
    public void testThrottling() {
        ...
        if (PropertyLoader.CONTEXT_ROOT == null) {
            addUrl = "http://" + PropertyLoader.HOST_NAME + ":" + PropertyLoader.NHTTP_PORT + "/";
        } else {
            addUrl = "http://" + PropertyLoader.HOST_NAME + ":" + PropertyLoader.NHTTP_PORT + "/" + PropertyLoader.CONTEXT_ROOT + "/";
        }
