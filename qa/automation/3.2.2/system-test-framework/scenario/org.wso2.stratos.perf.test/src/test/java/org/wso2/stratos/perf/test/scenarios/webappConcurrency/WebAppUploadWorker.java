...
public class WebAppUploadWorker extends Thread {
    ...
    public void run() {
        ...
        AdminServiceWebAppAdmin AdminServiceWebAppAdmin = new AdminServiceWebAppAdmin(FrameworkSettings.APP_BACKEND_URL, filePath);
        AdminServiceWebAppAdmin.warFileUplaoder(sessionCookies);
    }
