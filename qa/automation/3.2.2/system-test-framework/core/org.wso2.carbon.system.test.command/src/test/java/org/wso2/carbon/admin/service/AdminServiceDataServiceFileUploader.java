...
public class AdminServiceDataServiceFileUploader {
    ...
    public void uploadDataServiceFile(String sessionCookie, String fileName, DataHandler dh) throws RemoteException, ExceptionException {
        new AuthenticateStub().authenticateStub(sessionCookie, dataServiceFileUploaderStub);

        dataServiceFileUploaderStub.uploadService(fileName, "", dh);
