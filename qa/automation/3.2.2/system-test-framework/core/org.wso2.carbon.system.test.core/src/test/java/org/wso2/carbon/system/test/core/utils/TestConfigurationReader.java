...
//        TestConfigurationReader tn = getInstance();
//        TestConfigurationReader.TestConfig testConfig = tn.getTestConfig("org.wso2.stratos.perf.test.scenarios.webappConcurrency.WebAppUploaderClient");
//
////        System.out.println(testConfig.aarArtifactMap);
//
////        testConfigurationReader.initialize();
//
//
//        Set s = testConfig.warArtifactMap.getKey();
//
//        Iterator it = s.iterator();
//
//        while (it.hasNext()) {
//            String key = (String) it.next();
//            System.out.println(key + "value : " + testConfig.warArtifactMap.getValues(key).toString());
//
