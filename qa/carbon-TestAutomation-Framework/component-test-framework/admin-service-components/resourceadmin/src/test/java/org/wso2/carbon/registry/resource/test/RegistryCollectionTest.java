...
public class RegistryCollectionTest extends TestTemplate {
    ...
    public void runSuccessCase() {
        try {
            ...
            CollectionContentBean collectionContentBean = new ResourceAdminCommand(resourceAdminServiceStub).getCollectionContentSuccessCase("/TestAutomation");
            ...
            new ResourceAdminCommand(resourceAdminServiceStub).deleteCollectionSuccessCase("/TestAutomation/movedCollections");
            ...
            new ResourceAdminCommand(resourceAdminServiceStub).deleteCollectionSuccessCase("/TestAutomation");
        }
        catch (Exception e) {
        }
