...
public class LocalEntryCommand extends TestCase {
    ...
    public boolean addEntrySuccessCase(String data) throws RemoteException, LocalEntryAdminException {
        boolean status = false;
        try {
            status = localEntryAdminServiceStub.addEntry(data);
        }
        catch (Exception e) {
            log.error("addEntry operation failed");
            Assert.fail("addEntry operation failed");
        }
       return status;
    }

    public boolean addEntryFailureCase(String data) throws RemoteException, LocalEntryAdminException {
        boolean status = false;
        try {
    ...
    public boolean deleteEntryKeySuccessCase(String entryKey) throws Exception {
        ...
        try {
            ...
            log.error("delete entry operation failed.");
            Assert.fail("delete entry operation failed.");
        }
         return status;
    }
    ...
    public ConfigurationObject[] getDependantSuccessCase(String entryName) throws Exception {
        ...
        try {
            ...
            log.error("Get dependant operation failed.");
            Assert.fail("Get dependant operation failed.");
        }
    ...
    public void getEntrySuccessCase(String entryKey) throws Exception {
        try {
            ...
            log.error("Get entry key operation failed.");
            Assert.fail("Get entry key operation failed.");
        }
    ...
    public String[] getEntryNameSuccessCase() throws Exception {
        ...
        try {
            ...
            log.error("Getting entry name failed");
            Assert.fail("Getting entry name failed");
        }
        return entryName;
    }
    ...
    public int getEntryDataCountSuccessCase() throws Exception {
        ...
        try {
            ...
            log.error("Getting entry count failed");
            Assert.fail("Getting entry count failed");
        }
    ...
    public EntryData[] paginateEntryDataSuccessCase(int pageNumber) throws Exception {
        ...
        try {
            ...
            log.error("Getting paginated page entry data failed");
            Assert.fail("Getting paginated page entry data failed");
        }
        return entryData;
    }
