...
public class LogMediatorHeaderLevelTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(LogMediatorHeaderLevelTest.class);
    String search_l1 = "inComing = ***Incoming Message***$";
    String search_l2 = "inExpression = Echo String - urn:getQuote";
    String search_l3 = "outgoing = ***Outgoing Message***";

    @Override
    public void init() {
        log.info("Initializing Header Level Log Mediator Tests");
        log.debug("Log Mediator Tests Initialised");
    }

    @Override
    public void runSuccessCase() {
        log.debug("Running Header Level Log Mediator SuccessCase ");
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-log"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "header" + File.separator + "synapse.xml";
            ...
            if (!result.toString().contains("IBM")) {
                Assert.fail();
                log.error("Header Level Log Mediation Failed");
            ...
            log.error("Header Level Log Mediator doesn't work : " + e.getMessage());
