...
public class TestRunner extends TestSuite {
    public static Test suite() throws Exception {
        ...
        testSuite.addTestSuite(LogMediatorFullLevelTest.class);
        testSuite.addTestSuite(LogMediatorHeaderLevelTest.class);
        testSuite.addTestSuite(LogMediatorCustomLevelTest.class);
        testSuite.addTestSuite(LogMediatorSimpleLevelTest.class);
