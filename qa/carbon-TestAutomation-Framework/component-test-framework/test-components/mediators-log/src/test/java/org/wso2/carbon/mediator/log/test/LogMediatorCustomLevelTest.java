...
public class LogMediatorCustomLevelTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(LogMediatorCustomLevelTest.class);
    ...
    @Override
    public void init() {
        log.info("Initializing Custom Level Log Mediator Tests");
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-log"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "custom" + File.separator + "synapse.xml";
