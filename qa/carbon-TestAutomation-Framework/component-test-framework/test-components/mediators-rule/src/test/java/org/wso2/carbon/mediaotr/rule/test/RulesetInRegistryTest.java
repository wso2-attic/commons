...
public class RulesetInRegistryTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(RulesetInRegistryTest.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-rule"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "rule_simple_reg.xml";
