...
public class MessageTransformationTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(MessageTransformationTest.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-rule"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "simple_msg_trans.xml";
