...
public class EndpointAdminCommand extends TestCase {
    ...
    public AddressEndpointData getAddressEndpointSuccessCase(String endpointName) {
        ...
        try {
            ...
            log.debug("getting endpointdata");
        }
        catch (Exception e) {
            log.error("error occur while getting addressEndpointData");
        }
        return addressEndpointData;
    }

    public AddressEndpointData getAddressEndpointFailueCase(String endpointName) {
        AddressEndpointData addressEndpointData = new AddressEndpointData();
        try {
            addressEndpointData = endpointAdminStub.getAddressEndpoint(endpointName);
    ...
    public LoadBalanceEndpointData getLoadBalanceEndpointDataSuccessCase(String endpointName) {
        ...
        try {
            ...
            log.debug("getting loadbalance endpointdata");
        }
        catch (Exception e) {
            log.error("error occur while getting loadbalance endpoint data");
        }
    ...
    public LoadBalanceEndpointData getLoadBalanceEndpointDataFailueCase(String endpointName) {
        ...
        try {
            loadBalanceEndpointData = endpointAdminStub.getLoadBalanceData(endpointName);
            log.error("Getting loadbalance endpoint data without authenticating admin service");
            Assert.fail("Getting loadbalance endpoint data without authenticating admin service");
        }
        catch (Exception e) {
        }
        return loadBalanceEndpointData;
    ...
    public DefaultEndpointData getDefaultEndpointDataSuccessCase(String endpointName) {
        ...
        try {
            ...
            log.debug("getting default endpointdata");
        }
        catch (Exception e) {
            log.error("error occur while getting default endpoint data");
        }
        return defaultEndpointData;
    }

    public DefaultEndpointData getDefaultEndpointDataFailueCase(String endpointName) {
        DefaultEndpointData defaultEndpointData = new DefaultEndpointData();
        try {
            defaultEndpointData = endpointAdminStub.getDefaultEndpoint(endpointName);
    ...
    public ConfigurationObject[] getDependentFailueCase(String endpointName) {
        ConfigurationObject[] configurationObjects = null;
        try {
            configurationObjects = endpointAdminStub.getDependents(endpointName);
    ...
    public boolean addDynamicEndpointSuccessCase(String key,String endpointName) {
        ...
        try {
            ...
            log.debug("Dunamic endpoint added");
        }
        catch (Exception e) {
            log.error("error occur while adding dynamic endpoint");
        }
        return methodStatus;
    }

    public boolean addDynamicEndpointFailueCase(String key,String endpointName) {
        boolean methodStatus = false;
        try {
            methodStatus = endpointAdminStub.addDynamicEndpoint(key,endpointName);;
    ...
    public OMElement convertEpDataSuccessCase(OMElement epData) {
        ...
        try {
            ...
            log.error("error occur while converting endpoint data");
        }
        return omElement;
    }

    public void convertEpDataFailueCase(OMElement epData) {
        try {
    ...
    public boolean deleteDynamicEpSuccessCase(String key) {
        ...
        try {
            ...
            log.error("error occur while deleting dynamic endpoint");
        }
        return methodStatus;
    }

    public void deleteDynamicEpFailueCase(String key) {
        try {
     ...
     public void enableStatSuccessCase(String epName) {
        try {
            ...
            log.error("error occur while enable statistics");
        }
    }

    public void enableStatFailueCase(String epName) {
        try {
            endpointAdminStub.enableStatistics(epName);
    ...
    public void disableStatSuccessCase(String epName) {
        try {
            ...
            log.error("error occur while disable statistics");
        }
    }

    public void disableStatFailueCase(String epName) {
        try {
            endpointAdminStub.disableStatistics(epName);
    ...
    public WSDLEndpointData getDlEndpointSuccessCase(String epName) {
        ...
        try {
            ...
            log.error("error occur while getting wsdl endpoint data");
        }
        return wsdlEndpointData;
    }

    public void getDlEndpointFailueCase(String epName) {
        WSDLEndpointData wsdlEndpointData = new WSDLEndpointData();
        try {
            wsdlEndpointData = endpointAdminStub.getdlEndpoint(epName);
    ...
    public String  getDynamicEndpointSuccessCase(String key) {
        ...
        try {
            ...
            log.error("error occur while getting dynamic endpoint");
        }
        return dynamicEndpoint;
    }

    public void getDynamicEndpointFailueCase(String key) {
        String dynamicEndpoint = null;
        try {
            dynamicEndpoint = endpointAdminStub.getDynamicEndpoint(key);
    ...
    public int getDynamicEndpointCountSuccessCase() {
        ...
        try {
            ...
            log.error("error occur while getting dynamic endpoint count");
        }
        return dynamicEpCount;
    }

    public void getDynamicEndpointCountFailueCase() {
        try {
    ...
    public String[]  getDynamicEndpointsSuccessCase(int pageNumber,int endpointsPerPage) {
        ...
        try {
            ...
            log.error("error occur while getting dynamic endpoints");
        }
        return dynamicEndpoints;
    }

    public void getDynamicEndpointsFailueCase(int pageNumber,int endpointsPerPage) {
        String[] dynamicEndpoint = null;
        try {
    ...
    public String  getEndpointSuccessCase(String epName) {
        ...
        try {
            ...
            log.error("error occur while getting endpoint");
        }
        return endpoint;
    }

    public void getEndpointFailueCase(String epName) {
        try {
    ...
    public boolean saveDynamicEndpointSuccessCase(String  key,String epName) {
        ...
        try {
            ...
            log.error("error occur while saving dynamic endpoint");
        }
        return isSaved;
    }

    public void saveDynamicEndpointFailueCase(String  key,String epName) {
        try {
    ...
    public boolean saveEndpointSuccessCase(String epName) {
        ...
        try {
            ...
            log.error("error occur while saving endpoint");
        }
        return isSaved;
    }

    public void saveEndpointFailueCase(String epName) {
        try {
    ...
    public boolean updateDynamicEndpointSuccessCase(String  key,String epName) {
        ...
        try {
            ...
            log.error("error occur while updating dynamic endpoint");
        }
        return isUpdate;
    }

    public void updateDynamicEndpointFailueCase(String  key,String epName) {
        try {
    ...
    public EndpointMetaData[] getEndpointMetaDataSuccessCase(int pageNumber,int endpointsPerPage) {
        ...
        try {
            ...
            log.debug("Getting Endpoint metadata");
        }
        catch (Exception e) {
            log.error("error occur while getting endpoint metadata");
        }
        return endpointMetaData;
    }

    public void getEndpointMetaDataFailueCase(int pageNumber,int endpointsPerPage) {
        try {
            endpointAdminStub.endpointData(pageNumber,endpointsPerPage);
            log.error("getting endpoint metadata without authenticating admin service");
            Assert.fail("getting endpoint metadata without authenticating admin service");
        }
        catch (Exception e) {
        }
    }
