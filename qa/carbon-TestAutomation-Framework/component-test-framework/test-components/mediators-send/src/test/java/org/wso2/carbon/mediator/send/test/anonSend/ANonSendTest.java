package org.wso2.carbon.mediator.send.test.anonSend;
...
public class ANonSendTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(ANonSendTest.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-send"
                    + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "anonSend" + File.separator + "synapse.xml";
