package org.wso2.carbon.mediator.property.test.getProperty.xpath;
...
public class GetPropertyXPathTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(GetPropertyXPathTest.class);

    @Override
    public void init() {
        log.info("Initializing Property Mediator xPath Tests");
        log.debug("Property Mediator xPath Tests Initialised");
    }

    @Override
    public void runSuccessCase() {
        log.debug("Property Mediator xPath SuccessCase ");
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-property"
                    + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "getProperty" + File.separator + "xpath" + File.separator + "synapse.xml";
            ...
            log.error("Property Mediator xPath doesn't work : " + e.getMessage());
