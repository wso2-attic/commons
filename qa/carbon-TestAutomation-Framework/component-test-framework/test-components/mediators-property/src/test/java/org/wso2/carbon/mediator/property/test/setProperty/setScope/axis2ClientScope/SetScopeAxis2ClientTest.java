    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-property"
                    + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "setProperty" + File.separator + "setScope" + File.separator + "axis2ClientScope" + File.separator + "synapse.xml";
