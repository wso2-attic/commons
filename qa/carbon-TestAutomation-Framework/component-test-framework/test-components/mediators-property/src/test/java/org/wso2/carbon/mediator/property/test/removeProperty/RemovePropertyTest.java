package org.wso2.carbon.mediator.property.test.removeProperty;
...
public class RemovePropertyTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(RemovePropertyTest.class);

    @Override
    public void init() {
        log.info("Initializing Property Mediator removeProperty Tests");
        log.debug("Property Mediator removeProperty Tests Initialised");
    }

    @Override
    public void runSuccessCase() {
        log.debug("Property Mediator removeProperty SuccessCase ");
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-property"
                    + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "removeProperty" + File.separator + "synapse.xml";
           //home/thilini/Desktop/framework/component-test-framework/mediators-property/src/test/resources/removeProperty
            ...
            if (!result.toString().contains("IBM")) {
                Assert.fail();
                log.error("Property Mediator xPath Test Failed");
            }
        }
        catch (Exception e) {
            log.error("Property Mediator removeProperty doesn't work : " + e.getMessage());
