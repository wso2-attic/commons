...
public class Sample650 extends SampleTestTemplate {
    private static final Log log = LogFactory.getLog(Sample650.class);
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample650 success case");
        log.debug("running sample650 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price"));
        log.info("running sample650 failure case");
        log.debug("running sample650 failure case");
    }
}
