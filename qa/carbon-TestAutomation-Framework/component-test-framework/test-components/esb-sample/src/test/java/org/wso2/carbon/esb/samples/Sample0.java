...
public class Sample0 extends SampleTestTemplate {
    ...
    protected void invokeClient() {
        ...
        clientLogHTTPProxy = Axis2Client.fireClient("ant stockquote -Daddurl=http://" + HOST_NAME + ":" + BACKENDSERVER_HTTP_PORT + "/services/SimpleStockQuoteService -Dprxurl=http://" + HOST_NAME + ":" + HTTP_PORT + "/");
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample0 success case");
        log.debug("running sample0 success case");
        clientLogHTTPProxy = "";
    ...
    protected void runFailureTest() {
        ...
        log.info("running sample0 failure case");
        log.debug("running sample0 failure case");
        clientLogHTTPProxy = "";
