...
//Ruby scripts for mediation
public class Sample353 extends SampleTestTemplate {
    ...
    void setSampleNo() {
        sampleNo = 353;
        //  fileDownload.getFile(); //downloading jruby-complete-1.3.0.wso2v1.jar to ESB_HOME/repository/components/dropins  either this way or copyFile() can be used.
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample353 success case");
        log.debug("running sample353 success case");
    ...
    protected void runFailureTest() {
        ...
        log.info("running sample353 failure case");
        log.debug("running sample353 failure case");
    }
}
