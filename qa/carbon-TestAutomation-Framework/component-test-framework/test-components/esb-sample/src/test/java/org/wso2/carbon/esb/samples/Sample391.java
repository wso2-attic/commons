...
public class Sample391 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample391 success case");
        log.debug("running sample391 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price"));
        log.info("running sample391 failure case");
        log.debug("running sample391 failure case");
    }
}
