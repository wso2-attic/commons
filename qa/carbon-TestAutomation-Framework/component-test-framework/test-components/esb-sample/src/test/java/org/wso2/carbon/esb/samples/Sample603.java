...
public class Sample603 extends SampleTestTemplate {
    private static final Log log = LogFactory.getLog(Sample603.class);
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample603 success case");
        log.debug("running sample603 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price"));
        log.info("running sample603 failure case");
        log.debug("running sample603 failure case");
    }
}
