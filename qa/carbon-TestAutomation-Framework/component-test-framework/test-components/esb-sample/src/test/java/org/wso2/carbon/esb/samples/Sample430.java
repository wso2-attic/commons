...
public class Sample430 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample430 success case");
        log.debug("running sample430 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price"));
        log.info("running sample430 failure case");
        log.debug("running sample430 failure case");
    }
}
