...
public class Sample200 extends SampleTestTemplate {
    private static final Log log = LogFactory.getLog(Sample200.class);
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample200 success case");
        log.debug("running sample200 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price ="));
        log.info("running sample200 failure case");
        log.debug("running sample200 failure case");
    }
