...
public class Sample3 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample3 success case");
        log.debug("running sample3 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price"));
        log.info("running sample3 failure case");
        log.debug("running sample3 failure case");
    }
}
