...
public class Sample351 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample351 success case");
        log.debug("running sample351 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Custom :: Stock price"));
        log.info("running sample351 failure case");
        log.debug("running sample351 failure case");
    }
}
