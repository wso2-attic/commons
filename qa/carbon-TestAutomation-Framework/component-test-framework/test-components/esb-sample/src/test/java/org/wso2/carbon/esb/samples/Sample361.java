...
//dbreport mediator sample
public class Sample361 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample361 success case");
        log.debug("running sample361 success case");
    ...
    protected void runFailureTest() {
        ...
        log.info("running sample361 failure case");
        log.debug("running sample361 failure case");
