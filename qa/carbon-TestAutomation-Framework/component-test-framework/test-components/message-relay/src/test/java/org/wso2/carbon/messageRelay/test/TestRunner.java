...
public class TestRunner extends TestSuite {
    ...
    public static Test suite() throws Exception {
        ...
        testSuite.addTestSuite(ChunkEnabledTest.class);
        testSuite.addTestSuite(ChunkDisabledTest.class);
        testSuite.addTestSuite(ChunkDefaultTest.class);
        testSuite.addTestSuite(HeaderProtocol_10Test.class);
        testSuite.addTestSuite(HeaderProtocol_11Test.class);
        testSuite.addTestSuite(POSTWithContentTypeTest.class);
