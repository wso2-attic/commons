...
public class Soap11FCodeClientTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(Soap11FCodeClientTest.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-fault"
                    + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "soap11_fcode_client.xml";
