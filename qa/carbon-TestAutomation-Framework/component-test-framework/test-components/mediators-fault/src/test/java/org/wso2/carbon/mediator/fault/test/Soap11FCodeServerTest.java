...
public class Soap11FCodeServerTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(Soap11FCodeServerTest.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-fault"
                    + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "soap11_fcode_server.xml";
