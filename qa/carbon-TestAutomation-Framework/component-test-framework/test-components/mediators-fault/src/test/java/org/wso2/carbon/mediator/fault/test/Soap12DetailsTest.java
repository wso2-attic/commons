...
public class Soap12DetailsTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(Soap12DetailsTest.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-fault"
                    + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "soap12_details.xml";
