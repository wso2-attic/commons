...
public class Soap12FCodeMustund extends TestTemplate {
    private static final Log log = LogFactory.getLog(Soap12FCodeMustund.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "mediators-fault"
                    + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "soap12_fcode_mustund.xml";
