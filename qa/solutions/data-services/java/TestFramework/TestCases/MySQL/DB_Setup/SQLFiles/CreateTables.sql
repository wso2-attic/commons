create table wsasset.Employees( EmployeeID int(50),
...
CREATE table wsasset.AssetCategories(AccetCategoryID int(50),
                             AccetCategory varchar(100),
                             PRIMARY KEY(AccetCategoryID));


create table wsasset.Assets(AssetID int(50),
...
create table wsasset.AssetStatus(StatusID int(50),
                         StatusDescription varchar(100),
                         PRIMARY KEY(StatusID));

create table wsasset.Depreciation(DepreciationID int(50),
                          AssetID int(50),
...
create table wsasset.Maintenance(MaintenanceID int(50),
                         AssetID int(50),
