...
public class SQL_Concat_My_At_Client {
	...
	public static void main(String[] args)throws org.apache.axis2.AxisFault 
	{
		...
		opts.setAction("urn:OP_Concat"); // soap action field copied from the wsdl file
		sc.setOptions(opts);
	...
	public static OMElement CreatePayload() // this function create a message to send to server
	{
		...
		OMElement OP1 = fac.createOMElement("OP_Concat", omns); // Operation name
		return OP1;
	}
