...
public class ESBAddNonWsdlAnonSeqProxyServiceTest extends CommonSetup {
    ...
    /*
   This method will test adding of a Proxy Service without a WSDL but with anonymous sequences
    */
    public void testAddNonWsdlAnonSeqProxyService() throws Exception {
        ...
        esbAddProxyServiceTest.testAddProxyService("proxy_non_wsdl_anonSeq", "None", null, null,null, "true", null);
        ...
        esbAddProxyServiceTest.testSelectInSequence("inSeqOpImp", "main","Add Child","Core","Log");
        ...
        esbAddProxyServiceTest.testSelectOutSequence("outSeqOpImp", "fault","Add Child","Core","Send");

        //Available options are faultSeqOpAnon, faultSeqOpReg, faultSeqOpImp, faultSeqOpNone
        esbAddProxyServiceTest.testSelectFaultSequence("faultSeqOpImp", "fault","Add Child","Core","Drop");
        esbAddProxyServiceTest.testSaveProxyService();

        esbAddProxyServiceTest.testVerifyProxy("proxy_non_wsdl_anonSeq");
        seleniumTestBase.logOutUI();        
    }
}
