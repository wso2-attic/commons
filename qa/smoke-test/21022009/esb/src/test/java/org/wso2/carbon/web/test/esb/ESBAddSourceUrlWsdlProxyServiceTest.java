...
public class ESBAddSourceUrlWsdlProxyServiceTest extends CommonSetup {
    ...
    /*
   This method will test adding of a Proxy Service which contains the WSDL as a source URL
    */
    public void testAddSourceUrlWsdlProxyService() throws Exception {
        ...
        esbAddProxyServiceTest.testAddProxyService("proxy_source_url_wsdl", "Specify source URL", "file:repository/samples/resources/proxy/sample_proxy_1.wsdl", null,null, "true", null);
        ...
        esbAddProxyServiceTest.testVerifyProxy("proxy_source_url_wsdl");
        seleniumTestBase.logOutUI();        
    }
}
