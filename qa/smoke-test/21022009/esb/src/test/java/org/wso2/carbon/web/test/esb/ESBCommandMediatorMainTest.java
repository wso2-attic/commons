...
public class ESBCommandMediatorMainTest extends CommonSetup{
    ...
    public void testAddmediator() throws Exception{
        ...
        esbCommon.testAddSequence("sequence_command");

        esbCommon.testAddRootLevelChildren("Add Child","Extension","Command");

        ESBCommandMediatorTest esbCommandMediatorTest = new ESBCommandMediatorTest(selenium);
        esbCommandMediatorTest.testAddCommandMediator("0","org.wso2.command","10","10",null,null,null);
