...
public class ESBCacheMediatorTest extends TestCase {
	 ...
	 */
    public void testAddCacheMediatorMainInfo(String level, String cacheId, String cacheScope, String cacheType, String cacheTimeout, String maxMsgSize) throws Exception{
     ...
     */
    public void testAddCacheImplementationInfo(String impType, String maxSize) throws Exception{
     ...
     */
    public void testAddOnCacheHitInfo(String onCacheHit, String resourceName) throws Exception{
