...
//		assertEquals("Manage", selenium.getText("//div[@id='menu']/ul/li[2]"));
        assertEquals("Service", selenium.getText("//div[@id='menu']/ul/li[3]/ul/li[1]"));
        ...
        esbCommon.testDocLinks("User Guide",null,null);
        ...
        esbCommon.testDocLinks("Forum","Project: WSO2 ESB","//div[@id='left']/h1");
        ...
        esbCommon.testDocLinks("Issue Tracker","All Projects : WSO2 ESB (Key: ESBJAVA)", "//h3");
        ...
        esbCommon.testDocLinks("Mailing Lists","WSO2 Project Mailing Lists", "//div[@id='middle-noright']/h1");
        ...
        esbCommon.testDocLinks("Sign-in Help","In the Sign-In panel, provide the user name and the password of your account and the server you want to sign in. Your user name and password will be authenticated, and you will authorized to perform functions according to your role.","//p[1]");
    }
}
