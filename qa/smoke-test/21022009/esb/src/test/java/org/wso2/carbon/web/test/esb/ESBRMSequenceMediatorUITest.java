...
public class ESBRMSequenceMediatorUITest extends TestCase {
	 ...
	 */
    public void testVerifyRouterMediator(String level, String messageSequence) throws Exception{
...
//        if (messageSequence.equals("singleRadio") &&  selenium.getValue(messageSequence).equals("on")){
//		    assertEquals("on", selenium.getValue("singleRadio"));
//        } else {
//		    assertEquals("off", selenium.getValue("singleRadio"));
//        }
//
//        if ( messageSequence.equals("correlationRadio") &&  selenium.getValue(messageSequence).equals("on")){
//		    assertEquals("on", selenium.getValue("correlationRadio"));
//        } else {
//		    assertEquals("off", selenium.getValue("correlationRadio"));
//        }
...
//        esbCommon.testMediatorHelp("RM Sequence");
