...
public class MTOMTest extends TestCase {
    ...
    public void testenableMTOM() throws Exception {
        ...
        String resourcefile = instReadXMLFileTest.ReadConfig("uploadFile", "MTOMTest");
    ...
    public static OMElement createPayload(String fileName) {
        ...
        public void testMTOMFileDownload() throws Exception {
            ReadXMLFileTest instReadXMLFileTest = new ReadXMLFileTest("GlobalConfig.xml");
            String inputfile = instReadXMLFileTest.ReadConfig("inputFile", "MTOMTest"); //Read from XML
            String outFilename = instReadXMLFileTest.ReadConfig("downloadFile", "MTOMTest");
            String serverIP = instReadXMLFileTest.ReadConfig("ip", "ServerConfig");
            String toEpr = "http://"+serverIP+":9763/services/MtomFileDownloadService/";
