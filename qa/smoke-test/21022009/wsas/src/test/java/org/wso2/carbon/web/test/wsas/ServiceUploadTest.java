...

{
    ...
    public void testPojo_upload() throws Exception {
        ...
        instSeleniumTestBase.SetFileBrowse("jarZipFilename", FilePath);
    ...
    /*public void testJaxWs_upload() throws Exception {
        ...
        browser.waitForPageToLoad("30000");
        instSeleniumTestBase.SetFileBrowse("filename", FilePath);
        browser.click("upload");
        browser.waitForPageToLoad("30000");
    ...
    public void testAxis1_upload() throws Exception {
        ...
        browser.click("upload");
        browser.waitForPageToLoad("30000");
        assertTrue(browser.isTextPresent("Files have been uploaded successfully. Please refresh this page in a while to seethe status of the created Axis1 service"));
        browser.click("//button[@type='button']");
        Thread.sleep(12000);
        browser.click("link=List");
        browser.waitForPageToLoad("120000");
   ...
   /* public void testSpring_upload() throws Exception {
        ...
        browser.waitForPageToLoad("30000");
        instSeleniumTestBase.SetFileBrowse("springContext", Contextfile);
        instSeleniumTestBase.SetFileBrowse("springBeans", Beansfile);
        browser.click("upload");
        browser.waitForPageToLoad("30000");
