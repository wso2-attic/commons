...
public class ManageAxis1ServiceTest extends TestCase {
    ...
    public void testAddServiceGroupModule() throws Exception {
        ...
        instServiceManagement.engageServiceGroupModule("Axis1Service.wsdd", "sandesha2-SNAPSHOT");
        instServiceManagement.disengageServiceGroupModule("Axis1Service.wsdd", "sandesha2-SNAPSHOT");
    }
