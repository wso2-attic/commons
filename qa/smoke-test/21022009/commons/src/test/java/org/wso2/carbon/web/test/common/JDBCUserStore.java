...
public class JDBCUserStore extends TestCase {
    ...
    String attrsSQL = "select * from userprofiles where username=?";
    String attrProfileSQL = "select country from userprofiles where profilename=?";
    String attrsProfileSQL = "select * from userprofiles where profilename=?";





    public JDBCUserStore(Selenium _browser) {
        selenium = _browser;
    }
    ...
    public void testExternalUserStoreUI() throws Exception {
    ...
    public void testCreateExternalUserStore() throws Exception {
        selenium.click("link=Add External User Store");
        selenium.waitForPageToLoad("30000");
        ...
        selenium.click("importAttrs");
        selenium.type("attrSQL", attrSQL);
        selenium.type("attrsSQL", attrsSQL);
        selenium.type("attrProfileSQL", attrProfileSQL);
        selenium.type("attrsProfileSQL", attrsProfileSQL);
    ...
    public void testUsers() throws Exception {
        ...
        assertTrue(selenium.isTextPresent("taniya"));
        selenium.click("//input[@value='Finish']");
        selenium.waitForPageToLoad("30000");
    }
