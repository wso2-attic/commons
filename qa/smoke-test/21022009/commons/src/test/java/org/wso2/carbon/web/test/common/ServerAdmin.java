...
public class ServerAdmin {
    ...
    public void startServer(String carbonHome) {
        try {
            ...
            String command1 = carbonHome + "\\bin\\wso2server.bat -start";
            String command2 = carbonHome + "/bin/wso2server.sh -start";
    ...
    public void manageServerCommands(String carbonHome, String option) {
        try {
            ...
            String command1 = carbonHome + "\\bin\\wso2server.bat -"+option;
            String command2 = carbonHome + "/bin/wso2server.sh -"+option;
            String osName = System.getProperty("os.name");
    ...
    public void stopServer(String carbonHome) {
        try {
            ...
            String command1 = carbonHome + "\\bin\\wso2server.bat -stop";
            String command2 = carbonHome + "/bin/wso2server.sh -stop";
            String osName = System.getProperty("os.name");
