...
/* Purpose	:	This is a sample client to verify the handling of "safe" annotation of WSO2 Mashup Server.
 * Author	: 	Yumani Ranaweera
 */

public class clientSafe {
	private static String toEpr = "http://localhost:7762/services/samples/safe/";
	
	 
	public static void main(String[] args) throws Exception{
		testEcho("helloSafe","testParam");
