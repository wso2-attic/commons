...
public class clientfileManupulation {
	
 public static String toEpr = "http://localhost:7762/services/samples/fileManupulation/";

	public static void main(String[] args) throws Exception{
		testEcho("createFileTest");
		testEcho("openFileTest");
		testEcho("closeFileTest");		
	}
