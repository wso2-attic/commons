...
public class TestContentStream extends TestSetup {
    ...
    public void testputResourceasStreamXML() throws RegistryException, FileNotFoundException {
        ...
        InputStream is = new BufferedInputStream(new FileInputStream("../conf/registry.xml"));
        String st = null;
        try {
            st = slurp(is);
        } catch (IOException e) {
    ...
    public void testContentStreaming() throws RegistryException, IOException {
    ...
    public void testsetContainStreamXML() throws RegistryException, FileNotFoundException {
