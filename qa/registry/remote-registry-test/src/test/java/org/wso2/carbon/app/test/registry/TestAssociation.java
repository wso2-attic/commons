...
public class TestAssociation extends TestSetup {

    public TestAssociation(String text) {
        super(text);
    }

    public void testAddAssociationToResource() throws RegistryException {
    ...
    public void testAddAssociationToCollection() throws RegistryException {
    ...
    public void testAddAssociationToRoot() throws RegistryException {
    ...
    public void testGetResourceAssociation() throws RegistryException {
    ...
    public void testGetCollectionAssociation() throws RegistryException {
    ...
    public void testGetRootAssociation() throws RegistryException {
    ...
    public void testRemoveResourceAssociation() throws RegistryException {
    ...
    public void testRemoveCollectionAssociation() throws RegistryException {
    ...
    public void testRemoveRootAssociation() throws RegistryException {
    ...
    public boolean associationSourcepathExists(String path, String sourcePath) throws RegistryException {
        Association association[] = registry.getAllAssociations(path);
        boolean value = false;
    ...
    public boolean getAssocitionbyDestinationByType(String path, String type, String destinationPath) throws RegistryException {
