...
public class ResourceHandling extends TestSetup {
    ...
    public void testGetResourceoperation() throws RegistryException {
    ...
    public void testGetCollectionoperation() throws RegistryException {
