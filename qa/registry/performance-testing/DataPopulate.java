...
public class DataPopulate extends TestCase {

    private static Registry registry = null;
    private static RegistryRealm realm = null;
    int maxResourceCount = 3000;
    ...
    public void testdatabaseStatistics() throws RegistryException{
         ...
         try{
            ...
            String[] tableArray= {"REG.VERSIONS","REG.ARTIFACTS","REG.COMMENTS",
                    ...
                    ,"REG.CHILDREN","REG.DEPENDENCY_MANAGEMENT"};
      ...
      public void testUpdateResouceContent1() throws Exception {

        Resource r1 = registry.newCollection();


        String path = "/d200/d2/d3/d4/d5";
        try {
            registry.put(path, r1);
        } catch (RegistryException e) {
            fail("Couldn't put content to path /d1/d2/d3/d4/");
        }

        Resource r3 = registry.newCollection();


        String path3 = "/d200/d2/d3/d4/d5/d6";
        try {
            registry.put(path3, r3);
        } catch (RegistryException e) {
            fail("Couldn't put content to path /d1/d2/d3/d4/");
        }

        Resource r2= registry.newResource();
        String path2 = "/d200/d2/d3/d4/d5/d6/r1.txt";
        String content = "this is my content1";
        r2.setContent(content.getBytes());
        r2.setDescription("This is r1 file description");
        r2.setProperty("key1", "value1");
        r2.setProperty("key2", "value2");

        try {
            registry.put(path2, r2);
        } catch (RegistryException e) {
