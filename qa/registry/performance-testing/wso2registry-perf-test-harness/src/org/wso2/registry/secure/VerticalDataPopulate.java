...
public class VerticalDataPopulate extends PerfTestingSetup {
    public VerticalDataPopulate(String text) {
      super(text);
    }
    ...
    public void testdeleteresourcetime() throws RegistryException{
        ...
        VerticalPathGenerator obj3 = new VerticalPathGenerator(maxFileToputResource,"r3.txt","aa");
    ...
    public void testdeletecollectiontime() throws RegistryException{
        ...
        VerticalPathGenerator obj3 = new VerticalPathGenerator(maxFileToputResource,"o","q");
