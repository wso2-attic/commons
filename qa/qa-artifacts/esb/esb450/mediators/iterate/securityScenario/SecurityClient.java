...
//        System.setProperty("javax.net.ssl.trustStore", "/home/evanthika/WSO2/CARBON/PRE-ALPHA/AS/16th-April-2012/wso2as-4.5.0-SNAPSHOT/repository/resources/security/wso2carbon.jks");
...
//        System.out.println("The result is " + result.getFirstElement().getText());
    ...
    public Policy loadPolicy(String xmlPath , String key_path) throws Exception {
        ...
        rc.setUser("admin");
//        rc.setUser("sandapa@sandapa.com");
    ...
    public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException {
        ...
        if (usage == WSPasswordCallback.USERNAME_TOKEN) {
            // Logic to get the password to build the username token
                 ...
                 if ("admin".equals(id)) {
//                 if ("sandapa@sandapa.com".equals(id)) {
//                pwcb.setPassword("phoenix");
