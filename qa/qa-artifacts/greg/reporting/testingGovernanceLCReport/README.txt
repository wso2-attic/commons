...
3. Do required changes to the TestingLCReportGenerator.java as required and create a jar out of it (already created jar available -  TestingLCReportGenerator.jar)
