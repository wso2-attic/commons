...
public class QueueSenderAll {
	...
	for(int i=1;i<=1;i=i+1){
        TextMessage textMessage = queueSession.createTextMessage("New Message :::::::::::REDELIVERY::::::: No :::"+i);
	//textMessage.setJMSExpiration(System.currentTimeMillis() + 40000);
	//queueSender.setTimeToLive(3000);
	//queueSender.send(textMessage,1, 1, 60000);
