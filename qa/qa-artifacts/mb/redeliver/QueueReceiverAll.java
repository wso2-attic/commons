...
public class QueueReceiverAll {
    ...
    public static void main(String[] args) throws NamingException, JMSException {
        QueueReceiverAll queueReceiver = new QueueReceiverAll();
	...
	int count=1;
        ...
        QueueSession queueSession =queueConnection.createQueueSession(false,1000);
               // queueConnection.createQueueSession(false, QueueSession.DUPS_OK_ACKNOWLEDGE);
	

	/**if(count=5){
	queueConnection.createQueueSession(false, QueueSession.DUPS_OK_ACKNOWLEDGE);
	}else{
	queueConnection.createQueueSession(false,1000);
	}*/
