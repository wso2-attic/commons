...
public class HierarchicalTopicPublisher_ImmediateChildren {
    ...
    String topicName = "lanka.colombo.nn.aa";
    // String topicName = "lanka.galle";
   // String topicName = "lanka.kandy.aa";
   // String topicName = "lanka.mathara";
 
    public static void main(String[] args) throws NamingException, JMSException {
    	HierarchicalTopicPublisher_ImmediateChildren topicPublisher = new HierarchicalTopicPublisher_ImmediateChildren();
