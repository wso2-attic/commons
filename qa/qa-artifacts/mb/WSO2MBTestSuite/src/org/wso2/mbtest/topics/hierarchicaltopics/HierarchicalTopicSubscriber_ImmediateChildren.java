...
public class HierarchicalTopicSubscriber_ImmediateChildren {
	 public static final String QPID_ICF = "org.wso2.andes.jndi.PropertiesFileInitialContextFactory";
	    ...
	    String topicName = "lanka.colombo.*";
	   
	  	 
	    public static void main(String[] args) throws NamingException, JMSException {
	    	HierarchicalTopicSubscriber_ImmediateChildren topicSubscriber = new HierarchicalTopicSubscriber_ImmediateChildren();
