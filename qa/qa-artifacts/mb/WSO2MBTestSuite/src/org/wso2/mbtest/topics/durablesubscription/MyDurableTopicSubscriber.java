...
public class MyDurableTopicSubscriber {
    ...
    private String subscriptionId = "mySub3";
    
    public static void main(String[] args) throws NamingException, JMSException {
    	MyDurableTopicSubscriber topicSubscriber = new MyDurableTopicSubscriber();
			...
			while(true){
					Message message = topicSubscriber.receive();
						if (message instanceof TextMessage) {
								...
								System.out.println(count+ ":::::::Recieved Message Content:::::: " + textMessage.getText());
