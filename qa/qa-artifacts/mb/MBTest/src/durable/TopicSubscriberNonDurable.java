...
public class TopicSubscriberNonDurable {
    ...
    public static void main(String[] args) throws NamingException, JMSException {
    	TopicSubscriberNonDurable topicSubscriber = new TopicSubscriberNonDurable();
    ...
    public void subscribe() throws NamingException, JMSException {
       ...
       // javax.jms.TopicSubscriber topicSubscriber = topicSession.createSubscriber(topic);
        ...
        javax.jms.TopicSubscriber  topicSubscriber = topicSession.createDurableSubscriber( topic, "mySub1_0001" );
