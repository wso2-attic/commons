...
public class QueueSenderMap {
    ...
    public static void main(String[] args) throws NamingException, JMSException {
        QueueSenderMap queueSender = new QueueSenderMap();
	...
	for(int i=1;i<=100;i=i+1){
		...
		javax.jms.MapMessage mapMessage=queueSession.createMapMessage();
			String myMessage = "fghjhjdfghjfghj";
        		byte[] data = myMessage.getBytes();
        	    mapMessage.setBytes("asanka",data);
