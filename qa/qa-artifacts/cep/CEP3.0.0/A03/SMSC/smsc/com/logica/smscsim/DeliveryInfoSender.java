...
public class DeliveryInfoSender extends ProcessingThread
{
    ...
    private SimpleDateFormat dateFormatter
        = new SimpleDateFormat(DELIVERY_RCPT_DATE_FORMAT);
    ...
    public void submit(PDUProcessor processor, SubmitSM submitRequest,
                       String messageId, int stat, int err)
    {
        DeliveryInfoEntry entry =
            new DeliveryInfoEntry(processor,submitRequest,stat,err,messageId);
    ...
    protected class DeliveryInfoEntry
    {
        ...
        public DeliveryInfoEntry(PDUProcessor processor, SubmitSM submit,
                                 int stat, int err, String messageId)
        {
