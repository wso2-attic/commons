...
public class Record
{
     ...
     * @param key the name (key) of the attribute to set
     ...
     * @result the value of the atrribute
     * @see Attribute
     */
     ...
     * @see Attribute
     */
    public Attribute get(int i) { return (Attribute)attributes.get(i); }
     ...
     * @see #get(int)
     */
    public int count() { return attributes.size(); }
