...
1. Checkout the ant build file from https://wso2.org/repos/wso2/trunk/commons/qa/db-configuration-scripts/build.xml
...
3. Edit database properties in build.xml.
...
ant startServerWindows -Dscript=false -Ddatabase.name=oracle  --command to start the server on Windows with oracle
                                                                using -Dsetup option.
