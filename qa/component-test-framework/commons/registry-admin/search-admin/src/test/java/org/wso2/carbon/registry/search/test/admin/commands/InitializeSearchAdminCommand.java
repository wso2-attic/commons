...
/**
 * Initialize SearchAdminService Command class
 */
public class InitializeSearchAdminCommand {

    private static final Log log = LogFactory.getLog(InitializeSearchAdminCommand.class);

    public SearchAdminServiceStub executeAdminStub(String sessionCookie) {
        log.debug("sessionCookie:" + sessionCookie);
        String serviceURL = FrameworkSettings.SERVICE_URL + "SearchAdminService";
