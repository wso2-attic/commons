...
/**
 * calling methods in ProfileAdminService using the returned stub
 */
public class ProfileAdminCommand extends TestCase {
    ...
    public void getUserProfileSuccessCase(String path)
            throws RemoteException, RegistryExceptionException, UserStoreExceptionException {
    ...
    public void putUserProfileSuccessCase(String path)
            throws RemoteException, RegistryExceptionException, UserStoreExceptionException {
    ...
    public void startGetUserProfileSuccessCase(String path, CallbackHandler callback)
    ...
    public void startPutUserProfileSuccessCase(String path, CallbackHandler callback)
            throws RemoteException {
