...
/**
 * LifeCycleManagementService initialization class: it returns lifeCycleManagementServiceStub
 */
public class InitializeLifeCycleManagementAdminCommand {

    private static final Log log = LogFactory.getLog(InitializeLifeCycleManagementAdminCommand.class);

    public LifeCycleManagementServiceStub executeAdminStub(String sessionCookie) {
