...
/**
 * Initializing ActivityAdminServiceCommand class
 */
public class InitializeActivityAdminCommand {
    private static final Log log = LogFactory.getLog(InitializeActivityAdminCommand.class);

    public ActivityAdminServiceStub executeAdminStub(String sessionCookie) {
        log.debug("sessionCookie:" + sessionCookie);
        String serviceURL = FrameworkSettings.SERVICE_URL + "ActivityAdminService";
