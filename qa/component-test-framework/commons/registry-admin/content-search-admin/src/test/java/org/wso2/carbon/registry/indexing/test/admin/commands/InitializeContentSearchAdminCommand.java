...
/**
 * ContentSearchAdminService initialization class: it returns contentSearchAdminServiceStub
 */
public class InitializeContentSearchAdminCommand {
    private static final Log log = LogFactory.getLog(InitializeContentSearchAdminCommand.class);

    public ContentSearchAdminServiceStub executeAdminStub(String sessionCookie) {
