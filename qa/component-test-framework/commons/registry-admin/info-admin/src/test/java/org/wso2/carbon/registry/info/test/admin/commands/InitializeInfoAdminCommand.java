...
public class InitializeInfoAdminCommand {
    private static final Log log = LogFactory.getLog(InitializeInfoAdminCommand.class);

    public InfoAdminServiceStub executeAdminStub(String sessionCookie) {
