...
public class InitializeAddServiceAdminCommand {
    private static final Log log = LogFactory.getLog(InitializeAddServiceAdminCommand.class);

    public AddServicesServiceStub executeAdminStub(String sessionCookie) {
