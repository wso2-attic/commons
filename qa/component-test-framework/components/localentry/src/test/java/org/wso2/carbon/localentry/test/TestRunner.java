...
public class TestRunner extends TestSuite {
    public static Test suite() throws Exception {
        ...
        testSuite.addTestSuite(InlinedTextAddAndDeleteLocalEntryCommandTest.class);
        testSuite.addTestSuite(InlinedXMLAddAndDeleteLocalEntryCommandTest.class);
        testSuite.addTestSuite(SourceURLAddAndDeleteLocalEntryCommandTest.class);
        //testSuite.addTestSuite(LocalEntrywithEmptyValue.class);
        return testSuite;
    }
}
