...
public class SecurityScenarioTest extends TestTemplate {
        ...
        try {
            ...
            for (int scenario = 2; scenario <= 5; scenario++) {
                ...
                String xmlPath = frameworkPath + File.separator + "components" + File.separator + "proxyservices"
                                                 + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "testdata" + File.separator +"secureproxy.xml";
    ...
    private void createResources(ResourceAdminServiceStub resourceAdminServiceStub) throws Exception {
        ...
        new ResourceAdminCommand(resourceAdminServiceStub).addResourceSuccessCase("/_system/config/PolicyFiles/policy2.xml", "application/xml", "policy files", "file:///" + securityPolicy + File.separator + "policy2.xml", null);
        Thread.sleep(1000);
        new ResourceAdminCommand(resourceAdminServiceStub).addResourceSuccessCase("/_system/config/PolicyFiles/policy3.xml", "application/xml", "policy files", "file:///" + securityPolicy + File.separator + "policy3.xml", null);
        Thread.sleep(1000);
        new ResourceAdminCommand(resourceAdminServiceStub).addResourceSuccessCase("/_system/config/PolicyFiles/policy4.xml", "application/xml", "policy files", "file:///" + securityPolicy + File.separator + "policy4.xml", null);
        Thread.sleep(1000);
        new ResourceAdminCommand(resourceAdminServiceStub).addResourceSuccessCase("/_system/config/PolicyFiles/policy5.xml", "application/xml", "policy files", "file:///" + securityPolicy + File.separator + "policy5.xml", null);
        Thread.sleep(1000);
        new ResourceAdminCommand(resourceAdminServiceStub).addResourceSuccessCase("/_system/config/PolicyFiles/policy6.xml", "application/xml", "policy files", "file:///" + securityPolicy + File.separator + "policy6.xml", null);
        Thread.sleep(1000);
        new ResourceAdminCommand(resourceAdminServiceStub).addResourceSuccessCase("/_system/config/PolicyFiles/policy9.xml", "application/xml", "policy files", "file:///" + securityPolicy + File.separator + "policy9.xml", null);
        Thread.sleep(1000);
        new ResourceAdminCommand(resourceAdminServiceStub).addResourceSuccessCase("/_system/config/PolicyFiles/policy10.xml", "application/xml", "policy files", "file:///" + securityPolicy + File.separator + "policy10.xml", null);
        Thread.sleep(1000);
        new ResourceAdminCommand(resourceAdminServiceStub).addResourceSuccessCase("/_system/config/PolicyFiles/policy11.xml", "application/xml", "policy files", "file:///" + securityPolicy + File.separator + "policy11.xml", null);
        Thread.sleep(1000);
        new ResourceAdminCommand(resourceAdminServiceStub).addResourceSuccessCase("/_system/config/PolicyFiles/policy12.xml", "application/xml", "policy files", "file:///" + securityPolicy + File.separator + "policy12.xml", null);
        Thread.sleep(1000);
        new ResourceAdminCommand(resourceAdminServiceStub).addResourceSuccessCase("/_system/config/PolicyFiles/policy13.xml", "application/xml", "policy files", "file:///" + securityPolicy + File.separator + "policy13.xml", null);
        Thread.sleep(1000);
    }
