package org.wso2.carbon.mediator.route.test.ref_target;
...
public class RefTargetTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(RefTargetTest.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components" + File.separator + "mediators-router"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "ref_target" + File.separator + "synapse.xml";
