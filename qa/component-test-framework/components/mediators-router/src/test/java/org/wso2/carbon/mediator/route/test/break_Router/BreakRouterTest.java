package org.wso2.carbon.mediator.route.test.break_Router;
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components" + File.separator + "mediators-router"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "break_Router" + File.separator + "synapse.xml";
