package org.wso2.carbon.mediator.route.test.match;
...
public class MatchTest extends TestTemplate {
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components" + File.separator + "mediators-router"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "match" + File.separator + "synapse.xml";
