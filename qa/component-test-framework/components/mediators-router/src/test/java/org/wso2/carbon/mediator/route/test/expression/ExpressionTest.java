package org.wso2.carbon.mediator.route.test.expression;
...
public class ExpressionTest extends TestTemplate {
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components" + File.separator + "mediators-router"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "expression" + File.separator + "synapse.xml";
