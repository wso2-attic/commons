...
public class TestRunner extends TestSuite {
    ...
    public static Test suite() throws Exception {
        ...
        testSuite.addTestSuite(HandlerAddTest.class);
        testSuite.addTestSuite(HandlerGetCollectionLocationTest.class);
        testSuite.addTestSuite(HandlerGetConfigurationTest.class);
        testSuite.addTestSuite(HandlerGetListTest.class);
        testSuite.addTestSuite(HandlerUpdateTest.class);
