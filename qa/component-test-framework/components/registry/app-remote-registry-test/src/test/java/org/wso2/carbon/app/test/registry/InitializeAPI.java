...
public class InitializeAPI {
    ...
    public RemoteRegistry getRegistry(String carbonHome, String httpsPort, String httpPort) {
        try {
            ...
            System.setProperty("javax.net.ssl.trustStore", FrameworkSettings.CARBON_HOME + File.separator + "resources" + File.separator + "security" + File.separator + "wso2carbon.jks");
