...
public class PropertyReader {
    ...
    public static Properties loadRegistryProperties() throws IOException {
        ...
        properties.load(new FileInputStream(relativePath + File.separator + "components" + File.separator + "remote-registry-test" + File.separator + "resources" + File.separator + "remoteregistry.properties"));
