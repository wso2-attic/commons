...
public class DBLookupMediatorTest extends TestTemplate {
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components" + File.separator + "mediators-dbLookup"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resource" + File.separator + "dbLookup.xml";
