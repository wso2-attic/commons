...
public class Soap11ExpStringTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(Soap11ExpStringTest.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components" + File.separator + "mediators-fault"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "soap11_exp_string.xml";
