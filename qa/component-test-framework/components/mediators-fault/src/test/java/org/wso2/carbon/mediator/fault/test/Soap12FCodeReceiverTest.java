...
public class Soap12FCodeReceiverTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(Soap12FCodeReceiverTest.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components" + File.separator + "mediators-fault"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "soap12_fcode_receiver.xml";
