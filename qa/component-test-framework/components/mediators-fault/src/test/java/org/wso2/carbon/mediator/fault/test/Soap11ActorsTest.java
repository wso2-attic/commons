...
public class Soap11ActorsTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(Soap11ActorsTest.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components" + File.separator + "mediators-fault"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "soap11_actors.xml";
