...
public class Soap12ExpReason extends TestTemplate {
    private static final Log log = LogFactory.getLog(Soap12ExpReason.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components" + File.separator + "mediators-fault"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "soap12_exp_reason.xml";
