...
public class Soap12FCodeSenderTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(Soap12FCodeSenderTest.class);
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components" + File.separator + "mediators-fault"
                             + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "soap12_fcode_sender.xml";
            ...
            log.error("CFault Mediator SOAP12 doesn't work : " + e.getMessage());
