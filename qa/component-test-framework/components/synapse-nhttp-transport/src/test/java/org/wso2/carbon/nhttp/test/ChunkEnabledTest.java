...
public class ChunkEnabledTest extends TestTemplate {
    ...
    @Override
    public void init() {
        log.info("Initializing Chunk Enabled Tests");
        log.debug("Chunk Enabled Tests Initialised");
    }

    @Override
    public void runSuccessCase() {
        log.debug("Running Chunk Enabled SuccessCase ");
        ...
        try {
            ...
            for (int i = 0; ; i++) {
                ...
                e) {
            e.printStackTrace();
            log.error("Chunk Enabled Test doesn't work : " + e.getMessage());
