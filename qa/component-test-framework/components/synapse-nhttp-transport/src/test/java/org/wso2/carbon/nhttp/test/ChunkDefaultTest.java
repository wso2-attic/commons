...
public class ChunkDefaultTest extends TestTemplate {
    private static final Log log = LogFactory.getLog(ChunkDefaultTest.class);

    @Override
    public void init() {
        log.info("Initializing Chunk Default Tests");
        log.debug("Chunk Default Tests Initialised");
    }
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components"
                             + File.separator + "synapse-nhttp-transport" + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "chunking_default.xml";
