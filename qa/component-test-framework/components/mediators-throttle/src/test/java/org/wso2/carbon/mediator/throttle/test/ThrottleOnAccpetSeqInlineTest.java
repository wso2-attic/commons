...
public class ThrottleOnAccpetSeqInlineTest extends TestTemplate {
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            String xmlPath = frameworkPath + File.separator + "components" + File.separator + "mediators-throttle"
