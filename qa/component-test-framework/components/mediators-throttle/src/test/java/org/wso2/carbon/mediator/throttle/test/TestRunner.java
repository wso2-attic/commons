...
public class TestRunner extends TestSuite {
    ...
    public static Test suite() throws Exception {
        ...
        //testSuite.addTestSuite(ThrottleMediatorTest.class);
        testSuite.addTestSuite(ThrottleOnAccpetSeqKeyTest.class);
        testSuite.addTestSuite(ThrottleOnAccpetSeqInlineTest.class);
        testSuite.addTestSuite(ThrottleOnRejectSeqKeyTest.class);
