...
//        }
        ...
        if (BACKENDSERVER_RUNNING) {
            testSuite.addTestSuite(SequenceAddRemoveTest.class);
            testSuite.addTestSuite(TraceAndStatisticsTest.class);
            testSuite.addTestSuite(DynamicSequenceAddRemoveTest.class);
