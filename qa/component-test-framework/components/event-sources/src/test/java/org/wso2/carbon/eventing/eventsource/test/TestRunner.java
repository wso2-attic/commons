...
public class TestRunner extends TestSuite {
    public static Test suite() throws Exception {
        ...
        testSuite.addTestSuite(DefaultInMemAddRemoveESTest.class);
        testSuite.addTestSuite(RemoteRegAddRemoveESTest.class);
        testSuite.addTestSuite(EmbeddedRegAddRemoveTests.class);
