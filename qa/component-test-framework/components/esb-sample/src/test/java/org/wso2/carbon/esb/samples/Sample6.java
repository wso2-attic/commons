...
public class Sample6 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample6 success case");
        log.debug("running sample6 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price"));
        log.info("running sample6 failure case");
        log.debug("running sample6 failure case");
    }
}
