...
public class Sample601 extends SampleTestTemplate {
    private static final Log log = LogFactory.getLog(Sample601.class);
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample601 success case");
        log.debug("running sample601 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price"));
        log.info("running sample601 failure case");
        log.debug("running sample601 failure case");
    }
}
