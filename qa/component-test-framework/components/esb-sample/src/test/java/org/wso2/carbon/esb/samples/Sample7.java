...
public class Sample7 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        Assert.assertTrue(clientLog.contains("Invalid custom quote request"));
        log.info("running sample7 success case");
        log.debug("running sample7 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Invalid custom quote request"));
        log.info("running sample7 failure case");
        log.debug("running sample7 failure case");
    }
}
