...
public class Sample350 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample350 success case");
        log.debug("running sample350 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Custom :: Stock price"));
        log.info("running sample350 failure case");
        log.debug("running sample350 failure case");
    }
}
