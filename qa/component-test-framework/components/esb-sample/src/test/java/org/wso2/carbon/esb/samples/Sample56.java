...
public class Sample56 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample56 success case");
        log.debug("running sample56 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price"));
        log.info("running sample56 failure case");
        log.debug("running sample56 failure case");
    }
