...
public class Sample8 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample8 success case");
        log.debug("running sample8 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Custom :: Stock price"));
        log.info("running sample8 failure case");
        log.debug("running sample8 failure case");
    }
}
