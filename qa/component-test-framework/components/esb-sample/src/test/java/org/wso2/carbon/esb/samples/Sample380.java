...
public class Sample380 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample380 success case");
        log.debug("running sample380 success case");
        clientLogHTTPProxy = "";
    ...
    protected void runFailureTest() {
        ...
        log.info("running sample380 failure case");
        log.debug("running sample380 failure case");
        clientLogHTTPProxy = "";
