...
public class Sample370 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample370 success case");
        log.debug("running sample370 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price"));
        log.info("running sample370 failure case");
        log.debug("running sample370 failure case");
    }
}
