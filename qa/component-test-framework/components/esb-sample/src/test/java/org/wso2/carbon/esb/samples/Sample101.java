...
public class Sample101 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample10 success case");
        log.debug("running sample10 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price ="));
        log.info("running sample101 failure case");
        log.debug("running sample101 failure case");
    }
