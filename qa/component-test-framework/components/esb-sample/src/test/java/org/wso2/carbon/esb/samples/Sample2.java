...
public class Sample2 extends SampleTestTemplate {
    ...
    protected void invokeClient() {
        ...
        clientLog1 = Axis2Client.fireClient("ant stockquote -Daddurl=http://" + HOST_NAME + ":" + BACKENDSERVER_HTTP_PORT + "/services/SimpleStockQuoteService -Dtrpurl=http://" + HOST_NAME + ":" + HTTP_PORT + "/ -Dsymbol=MSFT");
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample2 success case");
        log.debug("running sample2 success case");
        clientLog1 = "";
    }
    ...
    protected void runFailureTest() {
        ...
        log.info("running sample2 failure case");
        log.debug("running sample2 failure case");
        clientLog1 = "";
    }
}
