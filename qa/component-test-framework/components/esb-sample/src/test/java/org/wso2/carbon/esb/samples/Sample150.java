...
public class Sample150 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample150 success case");
        log.debug("running sample150 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price ="));
        log.info("running sample150 failure case");
        log.debug("running sample150 failure case");
    }
