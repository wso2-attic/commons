...
public class Sample155 extends SampleTestTemplate {
    ...
    protected void runSuccessTest() {
        ...
        log.info("running sample155 success case");
        log.debug("running sample155 success case");
    }

    @Override
    protected void runFailureTest() {
        Assert.assertFalse(clientLog.contains("Standard :: Stock price ="));
        log.info("running sample155 failure case");
        log.debug("running sample155 failure case");
    }
