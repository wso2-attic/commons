...
public class LoginTest extends TestCase {
    ...
    public void testNormal() throws Exception {
        ...
        if (FrameworkSettings.STRATOS.equalsIgnoreCase("true")) {
            ...
            clientTrustStorePath = FrameworkSettings.CARBON_HOME + File.separator + "repository" + File.separator + "resources" + File.separator + "security" + File.separator + "wso2carbon.jks";
        }
