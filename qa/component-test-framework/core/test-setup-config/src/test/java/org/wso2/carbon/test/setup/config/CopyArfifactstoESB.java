...
public class CopyArfifactstoESB extends TestTemplate {
    ...
    public void init() {
        try {
            ...
            String destDirPath_transform = FrameworkSettings.CARBON_HOME + File.separator + "repository" + File.separator + "samples" + File.separator + "resources" + File.separator + "transform" + File.separator;
            ...
            File destinations_xslt_echo_back = new File(destDirPath_transform + "echo_back.xslt");
            ...
            File destinations_xslt_echo_transform = new File(destDirPath_transform + "echo_transform.xslt");
